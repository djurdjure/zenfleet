...
CREATE TABLE public.organizations (
    ...
    time_format character varying(10) DEFAULT 'H:i'::character varying NOT NULL,
    number_format character varying(10) DEFAULT '1,234.56'::character varying NOT NULL,
    ...
    max_api_calls_per_hour integer DEFAULT 1000 NOT NULL,
    ...
    current_storage_mb integer DEFAULT 0 NOT NULL,
    api_calls_this_hour integer DEFAULT 0 NOT NULL,
    last_api_reset timestamp(0) without time zone,
    ...
    working_days json DEFAULT '[1,2,3,4,5]'::json NOT NULL,
    business_hours_start time(0) without time zone DEFAULT '08:00:00'::time without time zone NOT NULL,
    business_hours_end time(0) without time zone DEFAULT '18:00:00'::time without time zone NOT NULL,
    fleet_settings json,
    ...
    data_retention_period character varying(255) DEFAULT '3years'::character varying NOT NULL,
    ...
    ai character varying(14),
    nis character varying(15),
    trade_register character varying(50),
    wilaya character varying(2),
    manager_name character varying(255),
    manager_nin character varying(18),
    manager_function character varying(255),
    ...
    scan_manager_cin_path character varying(255),
    scan_manager_mandate_path character varying(255),
    ...
    CONSTRAINT organizations_billing_cycle_check CHECK (((billing_cycle)::text = ANY ((ARRAY['monthly'::character varying, 'quarterly'::character varying, 'annually'::character varying])::text[]))),
    ...
    CONSTRAINT organizations_data_retention_period_check CHECK (((data_retention_period)::text = ANY ((ARRAY['1year'::character varying, '3years'::character varying, '5years'::character varying, '7years'::character varying])::text[]))),
    CONSTRAINT organizations_manager_function_check CHECK (((manager_function)::text = ANY ((ARRAY['gerant'::character varying, 'directeur_general'::character varying, 'president'::character varying, 'administrateur'::character varying, 'mandataire'::character varying, 'autre'::character varying])::text[]))),
    CONSTRAINT organizations_organization_type_check CHECK (((organization_type)::text = ANY ((ARRAY['enterprise'::character varying, 'sme'::character varying, 'startup'::character varying, 'public'::character varying, 'ngo'::character varying, 'cooperative'::character varying, 'association'::character varying, 'sole_proprietorship'::character varying])::text[]))),
    CONSTRAINT organizations_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'active'::character varying, 'suspended'::character varying, 'inactive'::character varying, 'archived'::character varying, 'deleted'::character varying])::text[]))),
    CONSTRAINT organizations_subscription_plan_check CHECK (((subscription_plan)::text = ANY ((ARRAY['trial'::character varying, 'basic'::character varying, 'standard'::character varying, 'professional'::character varying, 'enterprise'::character varying, 'custom'::character varying])::text[])))
);
...
--
-- Name: TABLE organizations; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON TABLE public.organizations IS 'ZenFleet Enterprise Organizations - Multi-tenant fleet management organizations with comprehensive enterprise features';
...
COMMENT ON COLUMN public.organizations.country IS 'ISO 3166-1 alpha-2 country code';


--
-- Name: COLUMN organizations.nif; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.nif IS 'Numéro d''Identification Fiscale algérien (15 chiffres)';


--
-- Name: COLUMN organizations.ai; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.ai IS 'Article d''Imposition algérien (14 chiffres)';


--
-- Name: COLUMN organizations.nis; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.nis IS 'Numéro d''Identification Statistique algérien (15 chiffres)';


--
-- Name: COLUMN organizations.trade_register; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.trade_register IS 'Numéro de registre de commerce algérien (format: WW/YY-XXXXXX B SS)';


--
-- Name: COLUMN organizations.wilaya; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.wilaya IS 'Code wilaya algérienne (01-58)';


--
-- Name: COLUMN organizations.manager_name; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.manager_name IS 'Nom et prénom du responsable légal';


--
-- Name: COLUMN organizations.manager_nin; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.manager_nin IS 'Numéro d''Identification National du responsable (18 chiffres)';


--
-- Name: COLUMN organizations.manager_function; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.manager_function IS 'Fonction du responsable légal';


--
-- Name: COLUMN organizations.manager_email; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.manager_email IS 'Email du responsable légal';


--
-- Name: COLUMN organizations.scan_nif_path; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.scan_nif_path IS 'Chemin du scan du NIF';


--
-- Name: COLUMN organizations.scan_ai_path; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.scan_ai_path IS 'Chemin du scan de l''AI';


--
-- Name: COLUMN organizations.scan_nis_path; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.scan_nis_path IS 'Chemin du scan du NIS';


--
-- Name: COLUMN organizations.scan_manager_cin_path; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.scan_manager_cin_path IS 'Chemin du scan CIN du responsable';


--
-- Name: COLUMN organizations.scan_manager_mandate_path; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.organizations.scan_manager_mandate_path IS 'Chemin du scan procuration/mandat';
...
--
-- Name: organizations organizations_api_key_unique; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_api_key_unique UNIQUE (api_key);


--
-- Name: organizations organizations_email_unique; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: organizations organizations_nif_unique; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_nif_unique UNIQUE (nif);
...
--
-- Name: org_location_algeria_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX org_location_algeria_idx ON public.organizations USING btree (wilaya, city);


--
-- Name: org_nif_status_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX org_nif_status_idx ON public.organizations USING btree (nif, status);


--
-- Name: org_trade_register_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX org_trade_register_idx ON public.organizations USING btree (trade_register);


--
-- Name: org_type_country_status_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX org_type_country_status_idx ON public.organizations USING btree (organization_type, country, status);
...
--
-- Name: organization_search_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organization_search_idx ON public.organizations USING btree (name, legal_name, description);
...
--
-- Name: organizations_created_at_status_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_created_at_status_index ON public.organizations USING btree (created_at, status);


--
-- Name: organizations_industry_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_industry_index ON public.organizations USING btree (industry);
...
--
-- Name: organizations_parent_organization_id_status_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_parent_organization_id_status_index ON public.organizations USING btree (parent_organization_id, status);


--
-- Name: organizations_postal_code_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_postal_code_index ON public.organizations USING btree (zip_code);
...
--
-- Name: organizations_subscription_expires_at_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_subscription_expires_at_index ON public.organizations USING btree (subscription_expires_at);


--
-- Name: organizations_subscription_expires_at_status_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_subscription_expires_at_status_index ON public.organizations USING btree (subscription_expires_at, status);


--
-- Name: organizations_subscription_plan_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: organizations_wilaya_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX organizations_wilaya_index ON public.organizations USING btree (wilaya);
...
--
-- Name: subscription_status_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX subscription_status_idx ON public.organizations USING btree (subscription_plan, subscription_expires_at);
...
--
-- Name: user_limits_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX user_limits_idx ON public.organizations USING btree (current_users, max_users);
...
--
-- Name: organizations organizations_approved_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_approved_by_foreign FOREIGN KEY (approved_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: organizations organizations_billing_contact_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_billing_contact_id_foreign FOREIGN KEY (billing_contact_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: organizations organizations_primary_admin_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_primary_admin_id_foreign FOREIGN KEY (primary_admin_id) REFERENCES public.users(id) ON DELETE SET NULL;
