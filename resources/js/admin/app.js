...
// ✅ ENTERPRISE: ZenFleet SlimSelect wrapper (for x-zenfleet-select)
...
import {
    driverFormValidationCreate,
    driverFormValidationEdit,
    vehicleFormValidationCreate,
    vehicleFormValidationEdit
} from './forms/stepper-forms';
...
Alpine.data('vehicleFormValidationCreate', vehicleFormValidationCreate);
Alpine.data('vehicleFormValidationEdit', vehicleFormValidationEdit);
Alpine.data('driverFormValidationCreate', driverFormValidationCreate);
Alpine.data('driverFormValidationEdit', driverFormValidationEdit);

// Expose Alpine and stepper factories globally for Blade x-data expressions (Livewire navigate safe)
window.Alpine = Alpine;
window.Livewire = Livewire;
window.vehicleFormValidationCreate = vehicleFormValidationCreate;
window.vehicleFormValidationEdit = vehicleFormValidationEdit;
window.driverFormValidationCreate = driverFormValidationCreate;
window.driverFormValidationEdit = driverFormValidationEdit;
// Backward compatibility for legacy x-data names
window.vehicleFormValidation = vehicleFormValidationCreate;
window.driverFormValidation = driverFormValidationCreate;
