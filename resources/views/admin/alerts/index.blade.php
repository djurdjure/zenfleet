        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-6">
                <div class="p-4 bg-gradient-to-r from-red-500 to-orange-600 rounded-2xl shadow-lg">
                    <x-lucide-alert-triangle class="h-12 w-12 text-white" stroke-width="2" />
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-500 hover:shadow-xl transition-shadow">
            <div class="flex items-center">
                <div class="p-3 bg-indigo-100 rounded-full">
                    <x-lucide-wrench class="h-6 w-6 text-indigo-600" />
                </div>
                <div class="ml-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
            <div class="flex items-center">
                <div class="p-3 bg-orange-100 rounded-full">
                    <x-lucide-tool class="h-6 w-6 text-orange-600" />
                </div>
                <div class="ml-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
            <div class="flex items-center">
                <div class="p-3 bg-blue-100 rounded-full">
                    <x-lucide-trending-up class="h-6 w-6 text-blue-600" />
                </div>
                <div class="ml-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <button @click="refreshAlerts()"
                    ...
                    <x-lucide-refresh-cw class="h-4 w-4 mr-2" ::class="refreshing ? 'animate-spin' : ''" />
                    Actualiser
                </button>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="max-h-96 overflow-y-auto">
                ...
                <div class="p-8 text-center text-gray-500">
                    <x-lucide-check-circle class="h-12 w-12 mx-auto mb-3 text-green-500" />
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="overflow-x-auto">
            ...
            <div class="p-12 text-center text-gray-500">
                <x-lucide-check-circle class="h-16 w-16 mx-auto mb-4 text-green-500" />
