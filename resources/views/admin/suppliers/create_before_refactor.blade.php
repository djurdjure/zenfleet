...
@section('content')
{{-- ====================================================================
 🏢 FORMULAIRE CRÉATION FOURNISSEUR - ENTERPRISE GRADE V2.0
 ====================================================================
    ...
    <div class="py-4 px-4 mx-auto max-w-5xl lg:py-6">
        ...
        <div class="mb-6">
            ...
            <nav class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                ...
                <x-iconify icon="lucide:chevron-right" class="w-3 h-3 text-gray-400" />
                <span class="font-semibold text-gray-900">Nouveau</span>
            </nav>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Ajouter un nouveau fournisseur à votre réseau</p>
                </div>
            </div>
        </div>
