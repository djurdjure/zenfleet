            ...
            <x-card padding="p-0" margin="mb-6">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Type --}}
                        <div @change="validateField('supplier_type', $event.target.value)">
                        ...
                        @if(isset($categories) && $categories->count() > 0)
                            <div @change="validateField('supplier_category_id', $event.target.value)">
                                <label for="supplier_category_id" class="block mb-2 text-sm font-medium text-gray-900">
                                    Catégorie
                                </label>
                                <select
                                    ...
                                    class="tomselect bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    @change="validateField('supplier_category_id', $event.target.value)">
                                    <option value="">Sélectionnez une catégorie...</option>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('supplier_category_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
