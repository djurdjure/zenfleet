    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 sm:flex sm:space-x-3">
            ...
            <a href="{{ route('admin.vehicle-expenses.reports') }}"
               class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                <x-lucide-bar-chart-3 class="h-4 w-4 mr-2" />
                Rapports
            </a>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <x-lucide-receipt class="h-8 w-8 text-blue-500" />
                    </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <x-lucide-credit-card class="h-8 w-8 text-green-500" />
                    </div>
                    <div class="ml-5 w-0 flex-1">
                        <dl>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <x-lucide-clock class="h-8 w-8 text-yellow-500" />
                    </div>
                    <div class="ml-5 w-0 flex-1">
                        <dl>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <x-lucide-alert-circle class="h-8 w-8 text-red-500" />
                    </div>
                    <div class="ml-5 w-0 flex-1">
                        <dl>
        ...
        <div class="px-6 py-4">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="{{ route('admin.expense-budgets.index') }}"
                   class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400">
                    <div class="flex-shrink-0">
                        <x-lucide-wallet class="h-8 w-8 text-indigo-500" />
                    </div>
                    <div class="flex-1 min-w-0">
                        <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <a href="{{ route('admin.vehicle-expenses.recurring') }}"
                   class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400">
                    <div class="flex-shrink-0">
                        <x-lucide-repeat class="h-8 w-8 text-green-500" />
                    </div>
                    <div class="flex-1 min-w-0">
                        <span class="absolute inset-0" aria-hidden="true"></span>
