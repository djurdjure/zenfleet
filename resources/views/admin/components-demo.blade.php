...
<section class="bg-white ">
 ...
 {{-- TomSelect --}}
 <div>
 <h3 class="text-lg font-medium text-gray-900 mb-4">TomSelect (Liste déroulante avec recherche)</h3>
 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
 {{-- TomSelect simple --}}
 <x-tom-select
...
/&gt;</code></pre>
 ...
 <div>
 <h3 class="text-sm font-medium text-gray-900 mb-2">TomSelect (Recherche avancée)</h3>
