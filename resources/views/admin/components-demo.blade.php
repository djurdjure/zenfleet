    ...
    <div class="py-8 px-4 mx-auto max-w-7xl lg:py-16">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 ">
                Composants Flowbite-inspired avec Tailwind CSS, Iconify et support dark mode
            </p>
        </div>

        {{-- Icons (Iconify) --}}
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Icons (Iconify)</h2>

            <div class="space-y-4">
                {{-- Heroicons Collection --}}
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Heroicons (Collection par défaut)</h3>
                    <div class="flex flex-wrap items-center gap-4">
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:truck" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">truck</span>
                        </div>
                        <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-600 ">calendar</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:wrench-screwdriver" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">wrench-screwdriver</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:check-circle" class="w-6 h-6 text-green-600" />
                            <span class="text-sm text-gray-600 ">check-circle</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:exclamation-circle" class="w-6 h-6 text-red-600" />
                            <span class="text-sm text-gray-600 ">exclamation-circle</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-600 ">w-4 h-4 (16px)</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:truck" class="w-5 h-5 text-blue-600" />
                            <span class="text-sm text-gray-600 ">w-5 h-5 (20px)</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:truck" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">w-6 h-6 (24px)</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:truck" class="w-8 h-8 text-blue-600" />
                            <span class="text-sm text-gray-600 ">w-8 h-8 (32px)</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Couleurs Sémantiques</h3>
                    <div class="flex flex-wrap items-center gap-4">
                        <div class="flex items-center gap-2">
                            <x-iconify icon="heroicons:check-circle" class="w-6 h-6 text-green-600" />
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Autres Collections (Material Design Icons, Font Awesome, etc.)</h3>
                    <div class="flex flex-wrap items-center gap-4">
                        <div class="flex items-center gap-2">
                            <x-iconify icon="mdi:car" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">mdi:car</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="fa6-solid:truck" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">fa6-solid:truck</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <x-iconify icon="bi:gear" class="w-6 h-6 text-blue-600" />
                            <span class="text-sm text-gray-600 ">bi:gear</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            ...
            <div class="space-y-4">
                {{-- Variantes --}}
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Variantes</h3>
                ...
                {{-- Avec icônes --}}
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Avec Icônes</h3>
                    <div class="flex flex-wrap gap-3">
                ...
                {{-- Disabled --}}
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">État désactivé</h3>
                    <div class="flex flex-wrap gap-3">
                ...
                {{-- Liens --}}
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Liens stylés comme boutons</h3>
                    <div class="flex flex-wrap gap-3">
        ...
        {{-- Form Elements --}}
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Form Elements (Flowbite-inspired)</h2>

            <div class="space-y-8">
                {{-- Inputs --}}
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Inputs</h3>
                ...
                {{-- Textarea --}}
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Textarea</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Textarea simple --}}
                        <x-textarea
                            name="description"
                ...
                {{-- SlimSelect --}}
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">SlimSelect (Liste déroulante avec recherche)</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- SlimSelect simple --}}
                        <x-slim-select
                            name="vehicle_slimselect"
                            label="Véhicule (avec recherche)"
                            placeholder="Rechercher un véhicule...">
                            <option data-placeholder="true"></option>
                            <option value="1">AA-123-BB - Toyota Corolla</option>
                            <option value="2">CC-456-DD - Renault Master</option>
                            <option value="3">EE-789-FF - Peugeot Partner</option>
                            <option value="4">GG-012-HH - Citroën Berlingo</option>
                            <option value="5">II-345-JJ - Ford Transit</option>
                            <option value="6">KK-678-LL - Mercedes Sprinter</option>
                            <option value="7">MM-901-NN - Volkswagen Caddy</option>
                            <option value="8">OO-234-PP - Fiat Ducato</option>
                        </x-slim-select>

                        {{-- SlimSelect requis --}}
                        <x-slim-select
                            name="driver_slimselect"
                            label="Chauffeur assigné"
                        ...
                        {{-- SlimSelect avec erreur --}}
                        <x-slim-select
                            name="fuel_type_slimselect"
                            label="Type de carburant"
                        ...
                        {{-- SlimSelect avec aide --}}
                        <x-slim-select
                            name="maintenance_type_slim"
                ...
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Datepicker & TimePicker</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Datepicker simple --}}
                        <x-datepicker
        ...
        {{-- Alerts --}}
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Alerts</h2>
        ...
        {{-- Badges --}}
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Badges</h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Exemple de tableau (style Kilométrage)</h3>
        ...
        {{-- Tables --}}
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Tableaux (Style Kilométrage)</h2>

            <div class="space-y-6">
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-3">Tableau avec icônes et badges</h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 ">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Exemples de Code</h2>

            <div class="space-y-6">
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Button</h3>
...
&lt;/x-button&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Input</h3>
...
/&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Select</h3>
...
/&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Textarea</h3>
...
/&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">SlimSelect (Recherche avancée)</h3>
                    <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm"><code>&lt;x-slim-select
    name="vehicle"
    label="Véhicule"
    placeholder="Rechercher..."
    required&gt;
    &lt;option data-placeholder="true"&gt;&lt;/option&gt;
    &lt;option value="1"&gt;AA-123-BB&lt;/option&gt;
    &lt;option value="2"&gt;CC-456-DD&lt;/option&gt;
&lt;/x-slim-select&gt;</code></pre>
                </div>

                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Datepicker</h3>
...
/&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">TimePicker</h3>
...
/&gt;</code></pre>
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-900 mb-2">Alert</h3>
