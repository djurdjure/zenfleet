                    <ul class="zf-sidebar-nav grow overflow-x-hidden overflow-y-auto w-full px-2 py-4 mb-0 scrollbar-thin scrollbar-thumb-gray-400/30 scrollbar-track-transparent" role="tree">
                        {{-- Dashboard --}}
                        <li class="flex">
                            @php
                            ...
                            <a href="{{ $dashboardRoute }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ $isDashboardActive ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('admin.organizations.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.organizations.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs('admin.vehicles.*', 'admin.assignments.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.vehicles.*', 'admin.assignments.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    <div class="mr-1">
                                        <div class="px-1 py-2 h-full relative">
                                            ...
                                            @endphp
                                            <div class="absolute w-0.5 rounded-full zf-sidebar-rail-active transition-all duration-300"
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1.5">
                                        ...
                                        <a href="{{ route('admin.vehicles.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicles.index') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.assignments.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.assignments.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs(['admin.drivers.*', 'admin.sanctions.*']) ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs(['admin.drivers.*', 'admin.sanctions.*']) ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1">
                                        ...
                                        <a href="{{ route('admin.drivers.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.drivers.index') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.drivers.sanctions.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.drivers.sanctions.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('admin.depots.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.depots.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('driver.repair-requests.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('driver.repair-requests.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs('admin.mileage-readings.*', 'driver.mileage.*', 'admin.vehicles.*.mileage-history') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.mileage-readings.*', 'driver.mileage.*', 'admin.vehicles.*.mileage-history') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    <div class="mr-1">
                                        <div class="px-1 py-2 h-full relative">
                                            ...
                                            @endphp
                                            <div class="absolute w-0.5 rounded-full zf-sidebar-rail-active transition-all duration-300 h-1/2"
                                    ...
                                    <ul class="flex-1 space-y-1 pb-2">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ $mileageIndexRoute }}"
                                                class="flex items-center h-9 px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 {{ $isMileageIndexActive ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ $mileageUpdateRoute }}"
                                                class="flex items-center h-9 px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 {{ $isMileageUpdateActive ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
 ...
 ==================================================================== --}}
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs('admin.maintenance.*', 'admin.repair-requests.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.maintenance.*', 'admin.repair-requests.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1">
                                        ...
                                        <a href="{{ route('admin.maintenance.dashboard') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.maintenance.dashboard*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.maintenance.operations.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.maintenance.operations.index') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.maintenance.operations.kanban') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.maintenance.operations.kanban') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.maintenance.operations.calendar') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.maintenance.operations.calendar') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.maintenance.schedules.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.maintenance.schedules.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.repair-requests.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.repair-requests.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('admin.documents.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.documents.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('admin.suppliers.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.suppliers.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
 ...
 ==================================================================== --}}
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs('admin.vehicle-expenses.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.index') && !request()->has('filter') && !request()->has('section') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.create') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.create') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.dashboard') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.dashboard') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.index') }}?filter=pending_approval"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->get('filter') == 'pending_approval' ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.index') }}?section=groups"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->get('section') == 'groups' ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.export') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.export') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.vehicle-expenses.analytics.cost-trends') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.vehicle-expenses.analytics.cost-trends') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                        ...
                        <li class="flex">
                            <a href="{{ route('admin.reports.index') }}"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.reports.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                        ...
                        <li class="flex flex-col" x-data="{ open: {{ request()->routeIs('admin.users.*', 'admin.roles.*', 'admin.audit.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                class="flex items-center w-full h-11 px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.users.*', 'admin.roles.*', 'admin.audit.*') ? 'zf-sidebar-item-active' : 'zf-sidebar-item' }}">
                                ...
                                <div class="flex w-full mt-2 pl-3">
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1">
                                        ...
                                        <a href="{{ route('admin.users.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.roles.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.roles.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
                                        ...
                                        <a href="{{ route('admin.audit.index') }}"
                                            class="flex items-center w-full h-9 px-2.5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.audit.*') ? 'zf-sidebar-subitem-active' : 'zf-sidebar-subitem' }}">
