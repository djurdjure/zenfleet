    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-12 text-center">
            ...
            <div class="w-24 h-24 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg">
                <x-iconify icon="fa-solid:exclamation-triangle" class="w-8 h-8 text-white" />
            </div>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button onclick="window.location.reload()"
                        ...
                        <x-iconify icon="fa-solid:sync-alt" class="w-5 h-5" />
                    ...
                    <a href="{{ route('home') }}"
                        ...
                        <x-iconify icon="fa-solid:home" class="w-5 h-5" />
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    ...
                    <button type="submit"
                        ...
                        <x-iconify icon="fa-solid:sign-out-alt" class="w-5 h-5" />
