...
>
 ...
 <template x-if="type === 'success'"><x-iconify icon="heroicons:check-circle" class="h-6 w-6" /></template>
 <template x-if="type === 'error'"><x-iconify icon="heroicons:x-circle" class="h-6 w-6" /></template>
 <template x-if="type === 'warning'"><x-iconify icon="heroicons:exclamation-triangle" class="h-6 w-6" /></template>
 <template x-if="type === 'info'"><x-iconify icon="heroicons:information-circle" class="h-6 w-6" /></template>
 </div>
 ...
 <x-iconify icon="heroicons:x-mark" class="h-5 w-5" />
 </button>
 </div>
 </div>
 </div>
