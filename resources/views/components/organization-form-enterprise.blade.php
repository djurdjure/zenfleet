...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const organizationTypeSelect = new SlimSelect({
            select: '#organization-type-select',
            settings: {
                placeholderText: 'Sélectionner le type...',
                allowDeselect: false
            }
        });

        const statusSelect = new SlimSelect({
        ...
        const wilayaSelect = new SlimSelect({
            select: '#wilaya-select',
            settings: {
                placeholderText: 'Sélectionner une wilaya...',
                allowDeselect: false,
