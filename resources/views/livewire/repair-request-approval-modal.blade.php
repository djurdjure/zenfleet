                ...
                <form wire:submit="submit">
                                    ...
                                    <div class="mt-4 space-y-3">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-2">
                                            <div class="flex justify-between text-sm">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Véhicule:</span>
                                                <span class="text-gray-900 dark:text-gray-100">
                                                    {{ $repairRequest->vehicle->vehicle_name ?? $repairRequest->vehicle->license_plate }}
                                                </span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Chauffeur:</span>
                                                <span class="text-gray-900 dark:text-gray-100">
                                                    {{ $repairRequest->driver->user->name ?? 'N/A' }}
                                                </span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Demande:</span>
                                                <span class="text-gray-900 dark:text-gray-100">
                                                    {{ Str::limit($repairRequest->title, 40) }}
                                                </span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Urgence:</span>
                                                <span>
                                                    @php
                                                        $urgencyConfig = [
                                        ...
                                        @else
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    rows="4"
                                                    required
                                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <button
                            ...
                            class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600"
                        >
                            Annuler
                        </button>
                    </div>
