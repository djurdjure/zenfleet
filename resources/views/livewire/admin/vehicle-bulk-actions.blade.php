<div x-data="vehicleBulkActions()" 
    ...
    <div x-show="selectedCount > 0"
         ...
         :style="menuPosition"
         class="z-50 bg-gray-900 text-white rounded-2xl shadow-2xl px-4 py-3 
                backdrop-blur-xl bg-opacity-95 border border-gray-700
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-1 border-l border-gray-700 pl-3">
                    <button @click="selectAllOnPage = !selectAllOnPage; $wire.selectAllVehicles()"
                            class="px-2 py-1 text-xs bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors"
                            :class="selectAllOnPage ? 'bg-blue-600 hover:bg-blue-700' : ''">
                    ...
                    <button @click="selectAll = !selectAll; $wire.selectAllVehicles()"
                            class="px-2 py-1 text-xs bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors"
                            :class="selectAll ? 'bg-blue-600 hover:bg-blue-700' : ''">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" x-data="{ showSubmenu: false }">
                    ...
                    <div x-show="showSubmenu"
                         ...
                         class="absolute bottom-full mb-2 left-0 bg-gray-800 rounded-lg 
                                shadow-xl border border-gray-700 py-2 min-w-[200px]">
                        
                        @if($action === 'change_status')
                            @foreach($statuses as $status)
                            <button wire:click="executeBulkAction('change_status', {{ $status->id }})"
                                    class="w-full text-left px-3 py-2 text-sm text-gray-300 
            ...
            <div class="flex items-center gap-2 border-l border-gray-700 pl-3">
                ...
                <button @click="$wire.undo()"
                        ...
                        class="p-1.5 rounded-lg bg-gray-800 hover:bg-gray-700 
                               disabled:opacity-50 disabled:cursor-not-allowed transition-all
                               hover:scale-110 active:scale-95"
                        title="Annuler (Ctrl+Z)">
                    <x-iconify icon="lucide:undo-2" class="w-4 h-4 text-gray-400" />
                </button>
                ...
                <button @click="$wire.redo()"
                    ...
                    <x-iconify icon="lucide:redo-2" class="w-4 h-4 text-gray-400" />
                </button>
                ...
                <button @click="$wire.clearSelection()"
                    ...
                    <x-iconify icon="lucide:x" class="w-4 h-4 text-red-400" />
                </button>
            </div>
        </div>
        ...
        <div x-show="$wire.isProcessing" 
             x-transition
             class="mt-3 bg-gray-800 rounded-lg p-2">
            <div class="flex items-center justify-between mb-1">
                <span class="text-xs text-gray-400" x-text="$wire.progressMessage"></span>
    ...
    <div x-data="{ notifications: [] }"
        ...
        <template x-for="(notification, index) in notifications" :key="index">
            <div x-transition:enter="transition ease-out duration-300"
                 ...
                 class="bg-gray-900 text-white rounded-lg shadow-xl px-4 py-3 min-w-[300px]
                        border-l-4"
                 :class="{
