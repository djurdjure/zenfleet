<div>
    {{-- ====================================================================
     👮 GESTION DES SANCTIONS - ULTRA-PROFESSIONAL ENTERPRISE-GRADE
     ==================================================================== --}}
            ...
            <div x-show="showFilters" x-collapse class="mt-4 bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <x-slim-select wire:model.live="filterSanctionType" name="filterSanctionType" placeholder="Tous les types">
                    ...
                    <div>
                        ...
                        <x-slim-select wire:model.live="filterDriverId" name="filterDriverId" placeholder="Tous les chauffeurs">
                            <option value="" data-placeholder="true">Tous les chauffeurs</option>
                    ...
                    <div class="col-span-1 md:col-span-2 grid grid-cols-2 gap-4">
                        ...
                        <div x-data="{
                            ...
                            init() {
                                ...
                                $watch('selectedDate', () => this.parseDate());
                            },
                            parseDate() {
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full px-3 py-2 text-sm border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 cursor-pointer">
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                    <x-iconify icon="heroicons:calendar-days" class="w-4 h-4 text-gray-400" />
                                </div>
                                ...
                                <div x-show="showCalendar"
                                    ...
                                    class="absolute z-50 mt-1 bg-white rounded-lg shadow-xl border border-gray-200 p-4 w-64"
                                    style="display: none;">
                                    {{-- Header --}}
                                    <div class="flex items-center justify-between mb-4">
                                        <button type="button" @click="prevMonth()" class="p-1 hover:bg-gray-100 rounded-md">
                                            <x-iconify icon="heroicons:chevron-left" class="w-4 h-4 text-gray-600" />
                                        </button>
                                        <span class="text-sm font-semibold text-gray-900" x-text="monthNames[currentMonth] + ' ' + currentYear"></span>
                                        <button type="button" @click="nextMonth()" class="p-1 hover:bg-gray-100 rounded-md">
                                            <x-iconify icon="heroicons:chevron-right" class="w-4 h-4 text-gray-600" />
                                        </button>
                                    </div>
                                        ...
                                        <template x-for="(day, index) in days" :key="index">
                                            <button type="button"
                                                ...
                                                :class="{
                                                    ...
                                                    'bg-blue-50 text-blue-600': day.isToday && !day.isSelected,
                                                ...
                                                class="w-8 h-8 flex items-center justify-center text-xs rounded-full transition-colors"
                                                x-text="day.day">
                                            </button>
                                        </template>
                                    </div>
                    ...
                    <div>
                        ...
                        <x-slim-select wire:model.live="filterArchived" name="filterArchived" placeholder="Actifs">
