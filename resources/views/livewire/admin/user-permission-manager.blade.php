<div class="py-6 sm:px-6 lg:px-8">
 ...
 <div class="mb-6 bg-red-50 border-l-4 border-red-400 p-4 /20">
 <div class="flex">
 ...
 class="text-xs px-3 py-1 bg-green-100 text-green-700 rounded-md hover:bg-green-200 /30 ">
 Tout sélectionner
 </button>
 <button type="button"
 wire:click="deselectAllInCategory('{{ $category }}')"
 class="text-xs px-3 py-1 bg-red-100 text-red-700 rounded-md hover:bg-red-200 /30 ">
 Tout désélectionner
 </button>
 </div>
 </div>
 ...
 <label class="flex items-center p-3 bg-white rounded-md cursor-pointer hover:bg-gray-100 :bg-gray-700 transition-colors">
 <input type="checkbox"
 ...
 <div class="mt-4 p-4 bg-blue-50 /20 rounded-md">
 <div class="flex">
 <div class="flex-shrink-0">
 ...
 @else
 <div class="mt-4 p-4 bg-gray-50 /50 rounded-md">
 ...
 <a href="{{ route('admin.users.index') }}"
 class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 :bg-gray-700">
 Annuler
 </a>
 <button type="submit"
