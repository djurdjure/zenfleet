...
function mileageForm() {
    return {
        ...
        init() {
            ...
            // Initialize TomSelect if in select mode
            @if($mode === 'select')
            this.$nextTick(() => {
                this.initTomSelect();
            });
            ...
            // Reinitialize TomSelect after Livewire updates
            Livewire.hook('message.processed', (message, component) => {
                if (component.id === @this.id) {
                    this.$nextTick(() => {
                        if (document.querySelector('.vehicle-select') && !document.querySelector('.vehicle-select').tomselect) {
                            this.initTomSelect();
                        }
                    });
                }
        ...
        initTomSelect() {
            ...
            if (selectElement && !selectElement.tomselect) {
                this.vehicleSelect = new TomSelect('.vehicle-select', {
