...
return new class extends Migration
{
    public function up(): void
    {
        if (
            ...
            !Schema::hasTable('maintenance_operations') ||
            !Schema::hasTable('vehicles') ||
            !Schema::hasColumn('maintenance_operations', 'vehicle_id')
        ) {
            return;
        }
        ...
        if (!$constraintExists) {
            DB::statement('ALTER TABLE maintenance_operations
                ADD CONSTRAINT fk_maintenance_operations_vehicle
    ...
    {
        if (Schema::getConnection()->getDriverName() !== 'pgsql' || !Schema::hasTable('maintenance_operations')) {
            return;
        }

        DB::statement('ALTER TABLE maintenance_operations DROP CONSTRAINT IF EXISTS fk_maintenance_operations_vehicle');
    }
};
