...
/**
 * 🧪 TEST MANUEL SIMPLIFIÉ: Création de chauffeur via Service
 */
...
// Données du formulaire (déjà validées)
$data = [
    'first_name' => 'Karim',
    ...
    'organization_id' => $admin->organization_id, // ✅ IMPORTANT: organization_id
];
