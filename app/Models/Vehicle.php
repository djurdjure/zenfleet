...
class Vehicle extends Model
{
    ...
    protected $fillable = [
        ...
        'fuel_type_id', 'transmission_type_id', 'vehicle_status_id', 'manufacturing_year',
    ...
    public function vehicleStatus(): BelongsTo { return $this->belongsTo(VehicleStatus::class); }
