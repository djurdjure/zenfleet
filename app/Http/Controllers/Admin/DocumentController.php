...
class DocumentController extends Controller
{
    ...
    public function create()
    {
        ...
        $drivers = User::where('organization_id', $organization_id)->get(['id', 'first_name', 'last_name']); // Assuming drivers are users
    ...
    public function edit(Document $document)
    {
        ...
        $vehicles = Vehicle::where('organization_id', $organization_id)->get(['id', 'brand', 'model', 'registration_plate']);
        $drivers = User::where('organization_id', $organization_id)->get(['id', 'first_name', 'last_name']);
        $suppliers = Supplier::where('organization_id', $organization_id)->get(['id', 'name']);
