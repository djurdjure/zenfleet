...
class DriverController extends Controller
{
    ...
    private function formatDate($dateString)
    {
        ...
        foreach ($formats as $format) {
            ...
            // On vérifie non seulement que la date a été créée, mais aussi qu'il n'y a eu aucune erreur ou avertissement.
            // C'est une vérification plus stricte qui évite les "faux positifs".
