...
class Button extends Component
{
    ...
    public function getClasses(): string
    {
        ...
        $variantClasses = match($this->variant) {
            'primary' => 'zenfleet-btn-primary text-white',
            'secondary' => 'text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-[#0c90ee] active:bg-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:active:bg-gray-600',
            ...
            default => 'zenfleet-btn-primary text-white',
        };
