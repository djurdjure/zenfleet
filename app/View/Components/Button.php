...
class Button extends Component
{
    ...
    /**
     * Get button classes based on variant and size (ZenFleet Blue Theme)
     */
    public function getClasses(): string
    {
        ...
        $variantClasses = match($this->variant) {
            'primary' => 'text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900',
            ...
            default => 'text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900',
        };
