...
class Textarea extends Component
{
    ...
    /**
     * Get textarea classes based on state (Enterprise-grade Light Mode)
     */
    public function getClasses(): string
    {
        $baseClasses = 'block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border transition-colors duration-200';
