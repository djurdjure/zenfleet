...
@section('title', 'Importation Véhicules - ZenFleet Enterprise')
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-gray-900">Importation Véhicules</h1>
                            <p class="text-gray-600 text-lg mt-2">
                                Importez votre flotte de véhicules en masse via fichier CSV
                            </p>
                        </div>
                    </div>
        ...
        <div class="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="instruction-card rounded-xl p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Les colonnes <strong>plaque</strong>, <strong>VIN</strong>, <strong>marque</strong> et <strong>modèle</strong> sont obligatoires.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="instruction-card rounded-xl p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Dates au format <strong>AAAA-MM-JJ</strong> et VIN de <strong>17 caractères</strong> exactement.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="instruction-card rounded-xl p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Enregistrez en CSV avec séparateur point-virgule et encodage UTF-8.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            <i class="fas fa-check-circle text-green-600"></i>
                            <span class="text-sm text-gray-700">Fichiers Excel (.xlsx, .xls)</span>
                        </div>
                        <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-3">
                            <i class="fas fa-info-circle text-blue-600"></i>
                            <span class="text-sm text-gray-700">Max: 1000 véhicules</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <form action="{{ route('admin.vehicles.import.handle') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                        @csrf
                            ...
                            <div class="file-input">
                                ...
                                <label for="import_file" class="cursor-pointer">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        Formats supportés: CSV, Excel • Taille max: 10 MB
                                    </div>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <label for="skip_duplicates" class="ml-3 text-sm text-gray-700">
                                        ...
                                        <p class="text-gray-500">Les véhicules avec des plaques ou VIN existants seront ignorés</p>
                                    </label>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <label for="update_existing" class="ml-3 text-sm text-gray-700">
                                        <span class="font-medium">Mettre à jour les véhicules existants</span>
                                        <p class="text-gray-500">Les données des véhicules existants seront mises à jour</p>
                                    </label>
                                </div>
                            </div>
                        </div>
