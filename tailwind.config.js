...
export default {
    darkMode: 'class', // Désactivation complète - nécessite classe .dark qui ne sera jamais ajoutée
    content: [
        ...
        function ({ addUtilities, addComponents, theme }) {
            ...
            addComponents({
                '.zenfleet-card': {
                    ...
                    'box-shadow': theme('boxShadow.zenfleet'),
                    'border': `1px solid ${theme('colors.gray.200')}`,
                    'overflow': 'hidden',
                    'transition': 'all 0.3s ease',
                    '&:hover': {
                        'box-shadow': theme('boxShadow.zenfleet-lg'),
                ...
                '.zenfleet-input': {
                    ...
                    '&:focus': {
                        ...
                        '--tw-ring-box-shadow': 'var(--tw-ring-inset) 0 0 0 calc(var(--tw-ring-width) + var(--tw-ring-offset-width)) var(--tw-ring-color)',
                        'box-shadow': 'var(--tw-ring-box-shadow)',
