...
\restrict 7WlRQpSvXfKTI45xndfky3iRJOjVEXdcfr52D26FBcDAgBNbSbae8162U851hTG
...
--
-- Name: expense_audit_create_monthly_partition(); Type: FUNCTION; Schema: public; Owner: zenfleet_user
--

CREATE FUNCTION public.expense_audit_create_monthly_partition() RETURNS void
    LANGUAGE plpgsql
    AS $$
            DECLARE
                next_month DATE;
...
ALTER FUNCTION public.expense_audit_create_monthly_partition() OWNER TO zenfleet_user;
...
--
-- Name: track_status_change(); Type: FUNCTION; Schema: public; Owner: zenfleet_user
--
...
BEGIN
    ...
    IF OLD.status IS DISTINCT FROM NEW.status THEN
        INSERT INTO status_histories (
            ...
            NOW(),
            COALESCE(NEW.status_metadata, '{}'::jsonb)
        );
        
        -- Mettre à jour status_changed_at
...
ALTER FUNCTION public.track_status_change() OWNER TO zenfleet_user;
...
WITH (fillfactor='85', autovacuum_vacuum_scale_factor='0.01', autovacuum_analyze_scale_factor='0.005');
...
CREATE TABLE public.comprehensive_audit_logs (
    ...
    CONSTRAINT chk_event_category CHECK (((event_category)::text = ANY (ARRAY[('authentication'::character varying)::text, ('authorization'::character varying)::text, ('data_access'::character varying)::text, ('data_modification'::character varying)::text, ('system_configuration'::character varying)::text, ('user_management'::character varying)::text, ('fleet_operations'::character varying)::text, ('financial'::character varying)::text, ('maintenance'::character varying)::text, ('compliance'::character varying)::text, ('security'::character varying)::text, ('integration'::character varying)::text]))),
...
CREATE TABLE public.driver_sanction_histories (
    ...
    CONSTRAINT driver_sanction_histories_action_check CHECK (((action)::text = ANY (ARRAY[('created'::character varying)::text, ('updated'::character varying)::text, ('archived'::character varying)::text, ('unarchived'::character varying)::text, ('deleted'::character varying)::text])))
);
...
CREATE TABLE public.driver_sanctions (
    ...
    status character varying(20) DEFAULT 'active'::character varying NOT NULL,
    notes text,
    CONSTRAINT driver_sanctions_sanction_type_check CHECK (((sanction_type)::text = ANY (ARRAY[('avertissement_verbal'::character varying)::text, ('avertissement_ecrit'::character varying)::text, ('mise_a_pied'::character varying)::text, ('mise_en_demeure'::character varying)::text, ('suspension_permis'::character varying)::text, ('amende'::character varying)::text, ('blame'::character varying)::text, ('licenciement'::character varying)::text]))),
    CONSTRAINT driver_sanctions_severity_check CHECK (((severity)::text = ANY (ARRAY[('low'::character varying)::text, ('medium'::character varying)::text, ('high'::character varying)::text, ('critical'::character varying)::text]))),
    CONSTRAINT driver_sanctions_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('appealed'::character varying)::text, ('cancelled'::character varying)::text, ('archived'::character varying)::text])))
);
...
CREATE TABLE public.drivers (
    ...
    assignment_status character varying(255) DEFAULT 'available'::character varying NOT NULL,
    last_assignment_end timestamp(0) without time zone,
    status_metadata jsonb DEFAULT '{}'::jsonb,
    CONSTRAINT drivers_assignment_status_check CHECK (((assignment_status)::text = ANY ((ARRAY['available'::character varying, 'assigned'::character varying, 'on_leave'::character varying, 'training'::character varying])::text[])))
)
WITH (fillfactor='90');
...
--
-- Name: COLUMN drivers.is_available; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.drivers.is_available IS 'Indique si le chauffeur est disponible pour affectation';


--
-- Name: COLUMN drivers.current_vehicle_id; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.drivers.current_vehicle_id IS 'ID du véhicule actuellement affecté';


--
-- Name: COLUMN drivers.assignment_status; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.drivers.assignment_status IS 'Statut d''affectation du chauffeur';


--
-- Name: COLUMN drivers.last_assignment_end; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.drivers.last_assignment_end IS 'Date/heure de fin de la dernière affectation';
...
CREATE TABLE public.expense_audit_logs (
    id bigint CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
    action character varying(50) CONSTRAINT expense_audit_logs_action_not_null1 NOT NULL,
    action_category character varying(50) CONSTRAINT expense_audit_logs_action_category_not_null1 NOT NULL,
    description text CONSTRAINT expense_audit_logs_description_not_null1 NOT NULL,
    old_values json,
    new_values json,
    changed_fields json DEFAULT '[]'::json CONSTRAINT expense_audit_logs_changed_fields_not_null1 NOT NULL,
    ip_address character varying(45),
    ...
    is_sensitive boolean DEFAULT false CONSTRAINT expense_audit_logs_is_sensitive_not_null1 NOT NULL,
    requires_review boolean DEFAULT false CONSTRAINT expense_audit_logs_requires_review_not_null1 NOT NULL,
    reviewed boolean DEFAULT false CONSTRAINT expense_audit_logs_reviewed_not_null1 NOT NULL,
    reviewed_by bigint,
    reviewed_at timestamp(0) without time zone,
    review_notes text,
    is_anomaly boolean DEFAULT false CONSTRAINT expense_audit_logs_is_anomaly_not_null1 NOT NULL,
    anomaly_details text,
    risk_level character varying(20),
    metadata json DEFAULT '{}'::json CONSTRAINT expense_audit_logs_metadata_not_null1 NOT NULL,
    tags json DEFAULT '[]'::json CONSTRAINT expense_audit_logs_tags_not_null1 NOT NULL,
    created_at timestamp(0) without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT expense_audit_logs_created_at_not_null1 NOT NULL
)
...
--
-- Name: expense_audit_logs_id_seq1; Type: SEQUENCE; Schema: public; Owner: zenfleet_user
--

CREATE SEQUENCE public.expense_audit_logs_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.expense_audit_logs_id_seq1 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: zenfleet_user
--

ALTER SEQUENCE public.expense_audit_logs_id_seq1 OWNED BY public.expense_audit_logs.id;


--
-- Name: expense_audit_logs_2025_05; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_05 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
    action character varying(50) CONSTRAINT expense_audit_logs_action_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_05 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_06; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_06 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_06 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_07; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_07 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_07 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_08; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_08 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_08 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_09; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_09 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_09 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_10; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_10 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_10 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_11; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_11 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_11 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2025_12; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2025_12 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2025_12 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2026_01; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2026_01 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2026_01 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2026_02; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2026_02 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2026_02 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2026_03; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2026_03 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2026_03 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2026_04; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2026_04 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2026_04 OWNER TO zenfleet_user;

--
-- Name: expense_audit_logs_2026_05; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.expense_audit_logs_2026_05 (
    id bigint DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass) CONSTRAINT expense_audit_logs_id_not_null1 NOT NULL,
    organization_id bigint CONSTRAINT expense_audit_logs_organization_id_not_null1 NOT NULL,
    vehicle_expense_id bigint CONSTRAINT expense_audit_logs_vehicle_expense_id_not_null1 NOT NULL,
    user_id bigint CONSTRAINT expense_audit_logs_user_id_not_null1 NOT NULL,
...
ALTER TABLE public.expense_audit_logs_2026_05 OWNER TO zenfleet_user;
...
END) STORED NOT NULL,
    ...
    updated_at timestamp(0) without time zone,
    deleted_at timestamp(0) without time zone,
    CONSTRAINT expense_budgets_budget_period_check CHECK (((budget_period)::text = ANY (ARRAY[('monthly'::character varying)::text, ('quarterly'::character varying)::text, ('yearly'::character varying)::text]))),
...
CREATE TABLE public.granular_permissions (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT granular_permissions_scope_check CHECK (((scope)::text = ANY (ARRAY[('global'::character varying)::text, ('organization'::character varying)::text, ('supervised'::character varying)::text, ('own'::character varying)::text])))
);
...
CREATE TABLE public.maintenance_alerts (
    ...
    updated_at timestamp(0) without time zone,
    deleted_at timestamp(0) without time zone,
    CONSTRAINT maintenance_alerts_alert_type_check CHECK (((alert_type)::text = ANY (ARRAY[('km_based'::character varying)::text, ('time_based'::character varying)::text, ('overdue'::character varying)::text]))),
    CONSTRAINT maintenance_alerts_priority_check CHECK (((priority)::text = ANY (ARRAY[('low'::character varying)::text, ('medium'::character varying)::text, ('high'::character varying)::text, ('critical'::character varying)::text])))
);
...
CREATE TABLE public.maintenance_documents (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT maintenance_documents_document_type_check CHECK (((document_type)::text = ANY (ARRAY[('invoice'::character varying)::text, ('report'::character varying)::text, ('photo_before'::character varying)::text, ('photo_after'::character varying)::text, ('warranty'::character varying)::text, ('other'::character varying)::text])))
);
...
CREATE TABLE public.maintenance_operations (
    ...
    updated_at timestamp(0) without time zone,
    deleted_at timestamp(0) without time zone,
    CONSTRAINT maintenance_operations_status_check CHECK (((status)::text = ANY (ARRAY[('planned'::character varying)::text, ('in_progress'::character varying)::text, ('completed'::character varying)::text, ('cancelled'::character varying)::text])))
);
ALTER TABLE ONLY public.maintenance_operations ALTER COLUMN notes SET COMPRESSION lz4;
...
CREATE TABLE public.maintenance_types (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT maintenance_types_category_check CHECK (((category)::text = ANY (ARRAY[('preventive'::character varying)::text, ('corrective'::character varying)::text, ('inspection'::character varying)::text, ('revision'::character varying)::text])))
);
...
--
-- Name: mileage_histories; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.mileage_histories (
    id bigint NOT NULL,
    vehicle_id bigint NOT NULL,
    driver_id bigint,
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT mileage_histories_type_check CHECK (((type)::text = ANY ((ARRAY['assignment_start'::character varying, 'assignment_end'::character varying, 'manual'::character varying, 'service'::character varying])::text[])))
);


ALTER TABLE public.mileage_histories OWNER TO zenfleet_user;

--
-- Name: mileage_histories_id_seq; Type: SEQUENCE; Schema: public; Owner: zenfleet_user
--

CREATE SEQUENCE public.mileage_histories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.mileage_histories_id_seq OWNER TO zenfleet_user;

--
-- Name: mileage_histories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zenfleet_user
--

ALTER SEQUENCE public.mileage_histories_id_seq OWNED BY public.mileage_histories.id;
...
--
-- Name: status_histories; Type: TABLE; Schema: public; Owner: zenfleet_user
--
...
ALTER TABLE public.status_histories OWNER TO zenfleet_user;

--
-- Name: mv_status_analytics; Type: MATERIALIZED VIEW; Schema: public; Owner: zenfleet_user
--

CREATE MATERIALIZED VIEW public.mv_status_analytics AS
 SELECT entity_type,
    new_status AS status,
    date_trunc('day'::text, changed_at) AS date,
    organization_id,
    count(*) AS transition_count,
    count(DISTINCT entity_id) AS unique_entities
   FROM public.status_histories
  WHERE (changed_at > (CURRENT_DATE - '90 days'::interval))
  GROUP BY entity_type, new_status, (date_trunc('day'::text, changed_at)), organization_id
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.mv_status_analytics OWNER TO zenfleet_user;
...
CREATE TABLE public.organizations (
    ...
    deleted_at timestamp(0) without time zone,
    email character varying(255),
    CONSTRAINT organizations_compliance_status_check CHECK (((compliance_status)::text = ANY (ARRAY[('compliant'::character varying)::text, ('warning'::character varying)::text, ('non_compliant'::character varying)::text, ('under_review'::character varying)::text]))),
    CONSTRAINT organizations_subscription_plan_check CHECK (((subscription_plan)::text = ANY (ARRAY[('trial'::character varying)::text, ('basic'::character varying)::text, ('professional'::character varying)::text, ('enterprise'::character varying)::text, ('custom'::character varying)::text])))
);
...
CREATE TABLE public.repair_requests (
    ...
    CONSTRAINT repair_requests_manager_decision_check CHECK (((manager_decision)::text = ANY (ARRAY[('valide'::character varying)::text, ('refuse'::character varying)::text]))),
    CONSTRAINT repair_requests_priority_check CHECK (((priority)::text = ANY (ARRAY[('urgente'::character varying)::text, ('a_prevoir'::character varying)::text, ('non_urgente'::character varying)::text]))),
    CONSTRAINT repair_requests_status_check CHECK (((status)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('accord_initial'::character varying)::text, ('accordee'::character varying)::text, ('refusee'::character varying)::text, ('en_cours'::character varying)::text, ('terminee'::character varying)::text, ('annulee'::character varying)::text]))),
    CONSTRAINT repair_requests_supervisor_decision_check CHECK (((supervisor_decision)::text = ANY (ARRAY[('accepte'::character varying)::text, ('refuse'::character varying)::text]))),
    ...
    CONSTRAINT valid_workflow CHECK (((((status)::text = 'accord_initial'::text) AND ((supervisor_decision)::text = 'accepte'::text)) OR (((status)::text = 'accordee'::text) AND ((manager_decision)::text = 'valide'::text)) OR (((status)::text = 'refusee'::text) AND (((supervisor_decision)::text = 'refuse'::text) OR ((manager_decision)::text = 'refuse'::text))) OR ((status)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('en_cours'::character varying)::text, ('terminee'::character varying)::text, ('annulee'::character varying)::text]))))
)
WITH (fillfactor='90');
ALTER TABLE ONLY public.repair_requests ALTER COLUMN description SET COMPRESSION lz4;
...
--
-- Name: status_histories_id_seq; Type: SEQUENCE; Schema: public; Owner: zenfleet_user
--
...
ALTER SEQUENCE public.status_histories_id_seq OWNER TO zenfleet_user;

--
-- Name: status_histories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_history; Type: TABLE; Schema: public; Owner: zenfleet_user
--

CREATE TABLE public.status_history (
    id bigint NOT NULL,
    statusable_type character varying(255) NOT NULL,
    ...
    change_type character varying(255) DEFAULT 'manual'::character varying NOT NULL,
    ip_address character varying(45),
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT status_history_change_type_check CHECK (((change_type)::text = ANY ((ARRAY['manual'::character varying, 'automatic'::character varying, 'system'::character varying])::text[])))
);


ALTER TABLE public.status_history OWNER TO zenfleet_user;

--
-- Name: COLUMN status_history.from_status; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.from_status IS 'Statut précédent (null si création)';


--
-- Name: COLUMN status_history.to_status; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.to_status IS 'Nouveau statut appliqué';


--
-- Name: COLUMN status_history.reason; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.reason IS 'Raison ou description du changement';


--
-- Name: COLUMN status_history.metadata; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.metadata IS 'Métadonnées additionnelles au format JSON';


--
-- Name: COLUMN status_history.change_type; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.change_type IS 'Type de changement (manual/automatic/system)';


--
-- Name: COLUMN status_history.ip_address; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.ip_address IS 'Adresse IP de l''utilisateur';


--
-- Name: COLUMN status_history.user_agent; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.user_agent IS 'User-Agent du navigateur';


--
-- Name: COLUMN status_history.changed_at; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.status_history.changed_at IS 'Date et heure du changement de statut';


--
-- Name: status_history_id_seq; Type: SEQUENCE; Schema: public; Owner: zenfleet_user
--
...
ALTER SEQUENCE public.status_history_id_seq OWNER TO zenfleet_user;

--
-- Name: status_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_transition_rules; Type: TABLE; Schema: public; Owner: zenfleet_user
--
...
ALTER TABLE public.status_transition_rules OWNER TO zenfleet_user;

--
-- Name: status_transition_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: zenfleet_user
--

CREATE SEQUENCE public.status_transition_rules_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.status_transition_rules_id_seq OWNER TO zenfleet_user;

--
-- Name: status_transition_rules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zenfleet_user
--

ALTER SEQUENCE public.status_transition_rules_id_seq OWNED BY public.status_transition_rules.id;
...
CREATE TABLE public.subscription_changes (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT subscription_changes_change_type_check CHECK (((change_type)::text = ANY (ARRAY[('upgrade'::character varying)::text, ('downgrade'::character varying)::text, ('renewal'::character varying)::text, ('cancellation'::character varying)::text]))),
    CONSTRAINT subscription_changes_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('processed'::character varying)::text, ('failed'::character varying)::text])))
);
...
CREATE TABLE public.subscription_plans (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT subscription_plans_tier_check CHECK (((tier)::text = ANY (ARRAY[('trial'::character varying)::text, ('basic'::character varying)::text, ('professional'::character varying)::text, ('enterprise'::character varying)::text, ('custom'::character varying)::text])))
);
...
CREATE TABLE public.suppliers (
    ...
    CONSTRAINT suppliers_supplier_type_check CHECK (((supplier_type)::text = ANY (ARRAY[('mecanicien'::character varying)::text, ('assureur'::character varying)::text, ('station_service'::character varying)::text, ('pieces_detachees'::character varying)::text, ('peinture_carrosserie'::character varying)::text, ('pneumatiques'::character varying)::text, ('electricite_auto'::character varying)::text, ('controle_technique'::character varying)::text, ('transport_vehicules'::character varying)::text, ('autre'::character varying)::text]))),
...
CREATE TABLE public.users (
    ...
    status character varying(255) DEFAULT 'active'::character varying NOT NULL,
    CONSTRAINT users_user_status_check CHECK (((user_status)::text = ANY (ARRAY[('active'::character varying)::text, ('inactive'::character varying)::text, ('suspended'::character varying)::text, ('pending'::character varying)::text])))
);
...
--
-- Name: v_database_health; Type: VIEW; Schema: public; Owner: zenfleet_user
--

CREATE VIEW public.v_database_health AS
 SELECT pg_database_size(current_database()) AS db_size_bytes,
    ...
    ( SELECT count(*) AS count
          ...
          WHERE (pg_stat_activity.state = 'active'::text)) AS active_queries,
    ( SELECT COALESCE(round(avg(EXTRACT(epoch FROM (now() - pg_stat_activity.query_start))), 2), (0)::numeric) AS "coalesce"
           FROM pg_stat_activity
          WHERE (pg_stat_activity.state = 'active'::text)) AS avg_query_duration_sec,
    round((((blks_hit)::numeric / (NULLIF((blks_hit + blks_read), 0))::numeric) * (100)::numeric), 2) AS cache_hit_ratio,
    (xact_commit + xact_rollback) AS total_transactions,
    xact_commit AS committed_transactions,
    xact_rollback AS rolled_back_transactions,
    round((((xact_commit)::numeric / (NULLIF((xact_commit + xact_rollback), 0))::numeric) * (100)::numeric), 2) AS commit_ratio,
...
ALTER VIEW public.v_database_health OWNER TO zenfleet_user;

--
-- Name: v_inefficient_indexes; Type: VIEW; Schema: public; Owner: zenfleet_user
--

CREATE VIEW public.v_inefficient_indexes AS
 SELECT schemaname,
  ...
  WHERE ((idx_scan < 50) AND (pg_relation_size((indexrelid)::regclass) > 65536))
  ORDER BY (pg_relation_size((indexrelid)::regclass)) DESC;


ALTER VIEW public.v_inefficient_indexes OWNER TO zenfleet_user;
...
CREATE TABLE public.vehicles (
    ...
    assignment_status character varying(255) DEFAULT 'available'::character varying NOT NULL,
    last_assignment_end timestamp(0) without time zone,
    CONSTRAINT vehicles_assignment_status_check CHECK (((assignment_status)::text = ANY ((ARRAY['available'::character varying, 'assigned'::character varying, 'maintenance'::character varying, 'reserved'::character varying])::text[])))
)
WITH (fillfactor='90');
...
--
-- Name: COLUMN vehicles.is_available; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicles.is_available IS 'Indique si le véhicule est disponible pour affectation';


--
-- Name: COLUMN vehicles.current_driver_id; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicles.current_driver_id IS 'ID du chauffeur actuellement affecté';


--
-- Name: COLUMN vehicles.assignment_status; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicles.assignment_status IS 'Statut d''affectation du véhicule';


--
-- Name: COLUMN vehicles.last_assignment_end; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicles.last_assignment_end IS 'Date/heure de fin de la dernière affectation';


--
-- Name: v_recent_status_changes; Type: VIEW; Schema: public; Owner: zenfleet_user
--

CREATE VIEW public.v_recent_status_changes AS
 SELECT sh.id,
    sh.entity_type,
    sh.entity_id,
        CASE
            WHEN ((sh.entity_type)::text = 'vehicles'::text) THEN v.registration_plate
            WHEN ((sh.entity_type)::text = 'drivers'::text) THEN (concat(d.first_name, ' ', d.last_name))::character varying
   ...
   FROM (((public.status_histories sh
     LEFT JOIN public.vehicles v ON ((((sh.entity_type)::text = 'vehicles'::text) AND (sh.entity_id = v.id))))
     LEFT JOIN public.drivers d ON ((((sh.entity_type)::text = 'drivers'::text) AND (sh.entity_id = d.id))))
     LEFT JOIN public.users u ON ((sh.changed_by = u.id)))
  WHERE (sh.changed_at > (CURRENT_DATE - '7 days'::interval))
  ORDER BY sh.changed_at DESC;


ALTER VIEW public.v_recent_status_changes OWNER TO zenfleet_user;

--
-- Name: v_slow_queries; Type: VIEW; Schema: public; Owner: zenfleet_user
--

CREATE VIEW public.v_slow_queries AS
 SELECT query,
    calls,
    round(((total_exec_time)::numeric / (calls)::numeric), 2) AS avg_time_ms,
    round((total_exec_time)::numeric, 2) AS total_time_ms,
    round(((((100)::double precision * total_exec_time) / sum(total_exec_time) OVER ()))::numeric, 2) AS pct_total_time,
    rows,
    round((((100)::numeric * (shared_blks_hit)::numeric) / (NULLIF((shared_blks_hit + shared_blks_read), 0))::numeric), 2) AS cache_hit_pct
...
ALTER VIEW public.v_slow_queries OWNER TO zenfleet_user;

--
-- Name: v_status_dashboard; Type: VIEW; Schema: public; Owner: zenfleet_user
--

CREATE VIEW public.v_status_dashboard AS
 SELECT 'vehicles'::text AS entity_type,
    vehicles.status,
    count(*) AS count,
    vehicles.organization_id
   FROM public.vehicles
  WHERE (vehicles.deleted_at IS NULL)
  GROUP BY vehicles.status, vehicles.organization_id
UNION ALL
 SELECT 'drivers'::text AS entity_type,
    drivers.status,
    count(*) AS count,
    drivers.organization_id
   FROM public.drivers
  WHERE (drivers.deleted_at IS NULL)
  GROUP BY drivers.status, drivers.organization_id;


ALTER VIEW public.v_status_dashboard OWNER TO zenfleet_user;

--
-- Name: v_table_sizes; Type: VIEW; Schema: public; Owner: zenfleet_user
--
...
CREATE VIEW public.v_table_sizes AS
 SELECT schemaname,
    ...
    pg_total_relation_size(((((schemaname)::text || '.'::text) || (tablename)::text))::regclass) AS total_size_bytes
   FROM pg_tables
  WHERE (schemaname = 'public'::name)
  ORDER BY (pg_total_relation_size(((((schemaname)::text || '.'::text) || (tablename)::text))::regclass)) DESC;


ALTER VIEW public.v_table_sizes OWNER TO zenfleet_user;
...
CREATE TABLE public.vehicle_depots (
    ...
    country_code character varying(2) DEFAULT 'DZ'::character varying NOT NULL,
    timezone character varying(50) DEFAULT 'Africa/Algiers'::character varying NOT NULL,
    ...
    metadata json,
    iot_config json,
    has_fuel_station boolean DEFAULT false NOT NULL,
    has_wash_station boolean DEFAULT false NOT NULL,
    has_maintenance_facility boolean DEFAULT false NOT NULL,
    has_charging_stations boolean DEFAULT false NOT NULL,
    charging_stations_count integer DEFAULT 0 NOT NULL,
    is_public boolean DEFAULT false NOT NULL,
    monthly_cost numeric(12,2),
    cost_currency character varying(3) DEFAULT 'DZD'::character varying NOT NULL,
    opened_at timestamp(0) without time zone,
    last_inspection_at timestamp(0) without time zone,
    next_inspection_at timestamp(0) without time zone
);
...
--
-- Name: COLUMN vehicle_depots.facilities; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.facilities IS 'Équipements disponibles';


--
-- Name: COLUMN vehicle_depots.services; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.services IS 'Services offerts';


--
-- Name: COLUMN vehicle_depots.certifications; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.certifications IS 'Certifications ISO, etc';


--
-- Name: COLUMN vehicle_depots.metadata; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.metadata IS 'Données flexibles';


--
-- Name: COLUMN vehicle_depots.iot_config; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.iot_config IS 'Configuration IoT/Sensors';


--
-- Name: COLUMN vehicle_depots.is_public; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_depots.is_public IS 'Accessible aux partenaires';
...
CREATE TABLE public.vehicle_expenses (
    ...
    CONSTRAINT valid_approval_status_v2 CHECK (((approval_status)::text = ANY (ARRAY[('draft'::character varying)::text, ('pending_level1'::character varying)::text, ('pending_level2'::character varying)::text, ('approved'::character varying)::text, ('rejected'::character varying)::text]))),
    ...
    CONSTRAINT valid_priority_level CHECK (((priority_level)::text = ANY (ARRAY[('low'::character varying)::text, ('normal'::character varying)::text, ('high'::character varying)::text, ('urgent'::character varying)::text]))),
    ...
    CONSTRAINT vehicle_expenses_expense_category_check CHECK (((expense_category)::text = ANY (ARRAY[('maintenance_preventive'::character varying)::text, ('reparation'::character varying)::text, ('pieces_detachees'::character varying)::text, ('carburant'::character varying)::text, ('assurance'::character varying)::text, ('controle_technique'::character varying)::text, ('vignette'::character varying)::text, ('amendes'::character varying)::text, ('peage'::character varying)::text, ('parking'::character varying)::text, ('lavage'::character varying)::text, ('transport'::character varying)::text, ('formation_chauffeur'::character varying)::text, ('autre'::character varying)::text])))
)
...
CREATE TABLE public.vehicle_handover_details (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT vehicle_handover_details_status_check CHECK (((status)::text = ANY (ARRAY[('Bon'::character varying)::text, ('Moyen'::character varying)::text, ('Mauvais'::character varying)::text, ('N/A'::character varying)::text, ('Oui'::character varying)::text, ('Non'::character varying)::text])))
);
...
CREATE TABLE public.vehicle_mileage_readings (
    ...
    CONSTRAINT vehicle_mileage_readings_recording_method_check CHECK (((recording_method)::text = ANY (ARRAY[('manual'::character varying)::text, ('automatic'::character varying)::text])))
)
...
CREATE TABLE public.vehicle_statuses (
    ...
    icon character varying(50) DEFAULT 'fa-car'::character varying NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
...
--
-- Name: COLUMN vehicle_statuses.can_be_assigned; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_statuses.can_be_assigned IS 'Le véhicule peut-il être affecté à un chauffeur ?';


--
-- Name: COLUMN vehicle_statuses.is_operational; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_statuses.is_operational IS 'Le véhicule est-il opérationnel ?';


--
-- Name: COLUMN vehicle_statuses.requires_maintenance; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_statuses.requires_maintenance IS 'Le véhicule nécessite-t-il une intervention ?';
...
CREATE TABLE public.vehicle_types (
    ...
    is_active boolean DEFAULT true NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    requires_special_license boolean DEFAULT false NOT NULL,
    required_license_category character varying(20),
    maintenance_cost_level integer DEFAULT 3 NOT NULL,
    average_capacity_tons numeric(8,2),
    organization_id bigint,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone
);
...
--
-- Name: COLUMN vehicle_types.requires_special_license; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_types.requires_special_license IS 'Nécessite un permis spécial ?';


--
-- Name: COLUMN vehicle_types.required_license_category; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_types.required_license_category IS 'Catégorie de permis requise (B, C, D, etc.)';


--
-- Name: COLUMN vehicle_types.maintenance_cost_level; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_types.maintenance_cost_level IS 'Niveau de coût de maintenance (1-5)';


--
-- Name: COLUMN vehicle_types.average_capacity_tons; Type: COMMENT; Schema: public; Owner: zenfleet_user
--

COMMENT ON COLUMN public.vehicle_types.average_capacity_tons IS 'Capacité moyenne de transport en tonnes';
...
--
-- Name: expense_audit_logs_2025_05; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_05 FOR VALUES FROM ('2025-05-01 00:00:00') TO ('2025-06-01 00:00:00');


--
-- Name: expense_audit_logs_2025_06; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_06 FOR VALUES FROM ('2025-06-01 00:00:00') TO ('2025-07-01 00:00:00');


--
-- Name: expense_audit_logs_2025_07; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_07 FOR VALUES FROM ('2025-07-01 00:00:00') TO ('2025-08-01 00:00:00');


--
-- Name: expense_audit_logs_2025_08; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_08 FOR VALUES FROM ('2025-08-01 00:00:00') TO ('2025-09-01 00:00:00');


--
-- Name: expense_audit_logs_2025_09; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_09 FOR VALUES FROM ('2025-09-01 00:00:00') TO ('2025-10-01 00:00:00');


--
-- Name: expense_audit_logs_2025_10; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_10 FOR VALUES FROM ('2025-10-01 00:00:00') TO ('2025-11-01 00:00:00');


--
-- Name: expense_audit_logs_2025_11; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_11 FOR VALUES FROM ('2025-11-01 00:00:00') TO ('2025-12-01 00:00:00');


--
-- Name: expense_audit_logs_2025_12; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_12 FOR VALUES FROM ('2025-12-01 00:00:00') TO ('2026-01-01 00:00:00');


--
-- Name: expense_audit_logs_2026_01; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_01 FOR VALUES FROM ('2026-01-01 00:00:00') TO ('2026-02-01 00:00:00');


--
-- Name: expense_audit_logs_2026_02; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_02 FOR VALUES FROM ('2026-02-01 00:00:00') TO ('2026-03-01 00:00:00');


--
-- Name: expense_audit_logs_2026_03; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_03 FOR VALUES FROM ('2026-03-01 00:00:00') TO ('2026-04-01 00:00:00');


--
-- Name: expense_audit_logs_2026_04; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_04 FOR VALUES FROM ('2026-04-01 00:00:00') TO ('2026-05-01 00:00:00');


--
-- Name: expense_audit_logs_2026_05; Type: TABLE ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_05 FOR VALUES FROM ('2026-05-01 00:00:00') TO ('2026-06-01 00:00:00');
...
ALTER TABLE ONLY public.expense_audit_logs ALTER COLUMN id SET DEFAULT nextval('public.expense_audit_logs_id_seq1'::regclass);
...
--
-- Name: mileage_histories id; Type: DEFAULT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories ALTER COLUMN id SET DEFAULT nextval('public.mileage_histories_id_seq'::regclass);
...
--
-- Name: status_histories id; Type: DEFAULT; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_history id; Type: DEFAULT; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_transition_rules id; Type: DEFAULT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_transition_rules ALTER COLUMN id SET DEFAULT nextval('public.status_transition_rules_id_seq'::regclass);
...
12	22	8	2025-09-12 14:00:00	2025-09-23 13:00:00	\N	\N	livraison	Affectation limité dans le temps	\N	\N	2025-11-13 13:17:34	2025-11-13 13:17:34	1	completed	4	\N	\N	2025-09-23 13:00:00
13	26	8	2025-09-23 15:00:00	2025-10-10 20:00:00	\N	\N	livraison	chevauchement de quelques heures	\N	\N	2025-11-13 20:41:41	2025-11-13 20:41:41	1	completed	4	\N	\N	2025-10-10 20:00:00
14	26	8	2025-10-10 20:01:00	2025-10-15 20:00:00	\N	\N	remplacement	test de mise à jour des statuts	\N	\N	2025-11-13 23:03:51	2025-11-13 23:03:51	1	completed	4	\N	\N	2025-10-15 20:00:00
16	22	8	2025-10-15 20:05:00	2025-10-23 14:00:00	\N	\N	livraison	test de gestion des statuts des chauffeurs et des véhicules	\N	\N	2025-11-13 23:26:11	2025-11-13 23:26:11	1	completed	4	\N	\N	2025-10-23 14:00:00
\.
...
10	67	5	1	\N	assigned	4	BULK: Affectation par lot	2025-11-08 02:31:17	2025-11-08 02:31:17	2025-11-08 02:31:17
11	22	16	1	\N	assigned	4	BULK: Affectation par lot	2025-11-08 02:31:34	2025-11-08 02:31:34	2025-11-08 02:31:34
12	67	16	1	5	transferred	4	BULK: Affectation par lot	2025-11-08 02:31:34	2025-11-08 02:31:34	2025-11-08 02:31:34
13	10	16	1	\N	assigned	4	BULK: Affectation par lot	2025-11-12 00:34:46	2025-11-12 00:34:46	2025-11-12 00:34:46
14	26	16	1	\N	assigned	4	BULK: Affectation par lot	2025-11-12 00:34:46	2025-11-12 00:34:46	2025-11-12 00:34:46
15	27	16	1	\N	assigned	4	BULK: Affectation par lot	2025-11-12 00:34:46	2025-11-12 00:34:46	2025-11-12 00:34:46
16	3	16	1	\N	assigned	4	BULK: Affectation par lot	2025-11-12 02:55:53	2025-11-12 02:55:53	2025-11-12 02:55:53
17	10	5	1	16	transferred	4	BULK: Affectation par lot	2025-11-12 02:56:09	2025-11-12 02:56:09	2025-11-12 02:56:09
\.
...
7	Disponible	disponible	Chauffeur disponible pour nouvelle affectation	#10b981	#065f46	user-check	t	t	t	t	1	1	\N	\N	\N	\N	2025-11-08 21:52:12	2025-11-08 21:52:12	\N	t	t	f
8	En mission	en_mission	Chauffeur actuellement affecté à un véhicule	#3b82f6	#1e40af	car	t	f	f	f	2	2	\N	\N	\N	\N	2025-11-08 21:52:12	2025-11-08 21:52:12	\N	t	f	f
9	En congé	en_conge	Chauffeur en congé (payé ou non payé)	#f59e0b	#92400e	umbrella-beach	t	f	f	f	3	3	\N	\N	\N	\N	2025-11-08 21:52:12	2025-11-08 21:52:12	\N	f	f	t
10	Autre	autre	Statut personnalisé ou temporaire	#6b7280	#374151	question-circle	t	f	f	f	10	5	\N	\N	\N	\N	2025-11-08 21:52:12	2025-11-08 21:52:12	\N	f	f	t
1	Actif	active	[LEGACY] Chauffeur actif et disponible pour les affectations	#10b981	white	fa-check-circle	t	f	t	t	1	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	t	t	f
2	En service	in-service	[LEGACY] Chauffeur actuellement en mission	#3b82f6	white	fa-road	t	f	t	t	2	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	t	f	f
3	En congé	on-leave	[LEGACY] Chauffeur en congé temporaire	#f59e0b	white	fa-calendar-times	t	f	t	t	3	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	f	f	f
4	En formation	in-training	[LEGACY] Chauffeur en cours de formation	#8b5cf6	white	fa-graduation-cap	t	f	t	t	4	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	f	f	t
5	Suspendu	suspended	[LEGACY] Chauffeur suspendu temporairement	#ef4444	white	fa-ban	f	f	t	t	5	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	f	f	t
6	Inactif	inactive	[LEGACY] Chauffeur inactif ou non disponible	#6b7280	white	fa-user-slash	f	f	t	t	6	1	\N	\N	\N	\N	2025-10-11 22:55:32	2025-11-08 21:52:12	\N	f	f	f
\.
...
COPY public.drivers (id, user_id, employee_number, first_name, last_name, photo, birth_date, blood_type, address, personal_phone, personal_email, license_number, license_issue_date, license_authority, recruitment_date, contract_end_date, status_id, emergency_contact_name, emergency_contact_phone, created_at, updated_at, deleted_at, full_address, license_expiry_date, organization_id, supervisor_id, license_categories, emergency_contact_relationship, notes, status, status_reason, status_expires_at, status_changed_at, status_changed_by, is_available, current_vehicle_id, assignment_status, last_assignment_end, status_metadata) FROM stdin;
4	14	\N	TestRole	Verification	\N	1989-07-23	O+	quelque part au milieu de null part	+213778025640	test001@dontexist.dz	\N	\N	\N	\N	\N	1	\N	\N	2025-10-12 20:33:50	2025-10-22 16:56:10	2025-10-22 16:56:10	\N	\N	1	\N	\N	\N	\N	disponible	\N	\N	2025-11-07 21:33:55.888326	\N	t	\N	available	\N	{}
8	22	DIF-2025-837	Said	merbouhi	drivers/photos/pVYpGOcweHjIEacsrchEl1BQL1LlidXYHavwtJ4N.png	2025-05-20	AB+	Cheraga, CP 16305,\r\nAlger	+213789056448	smerbouhi@gmail.com	DZ-0141503	2025-05-20	Daira El Biar	2025-05-20	2026-08-20	8	Merbouhi Ali	0674572386	2025-10-13 20:30:27	2025-11-13 23:26:11	\N	\N	2035-05-20	1	\N	["A","B"]	frère	aucun diplome	disponible	\N	\N	2025-11-07 21:33:55.888326	\N	t	\N	available	\N	{}
6	20	DLS-84745	zerrouk	ALIOUANE	drivers/photos/n2CrsympJ0sAh2wR8EParyAaWdSEgBx4cKa1kfPv.png	2025-05-20	O+	El Mouradia, BP 16100\r\nAlger	+213684849603	zaliouane@yahoo.fr	987-DZ-867	2025-05-20	Alger centre	2025-05-20	2027-01-23	7	Aliouane Cherif	0676135070	2025-10-12 23:59:59	2025-11-13 23:33:40	\N	\N	2035-05-20	1	\N	["B"]	\N	\N	disponible	\N	\N	2025-11-07 21:33:55.888326	\N	t	\N	available	\N	{}
\.


--
-- Data for Name: expense_audit_logs_2025_05; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_05 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_06; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_06 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_07; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_07 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_08; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_08 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_09; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_09 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_10; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_10 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_11; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_11 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2025_12; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2025_12 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2026_01; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2026_01 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2026_02; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2026_02 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2026_03; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2026_03 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2026_04; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2026_04 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.


--
-- Data for Name: expense_audit_logs_2026_05; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.expense_audit_logs_2026_05 (id, organization_id, vehicle_expense_id, user_id, action, action_category, description, old_values, new_values, changed_fields, ip_address, user_agent, session_id, request_id, previous_status, new_status, previous_amount, new_amount, is_sensitive, requires_review, reviewed, reviewed_by, reviewed_at, review_notes, is_anomaly, anomaly_details, risk_level, metadata, tags, created_at) FROM stdin;
\.
...
1	97584671-0aff-4b26-8ffe-e954742c3b6c	redis	default	{"uuid":"97584671-0aff-4b26-8ffe-e954742c3b6c","timeout":null,"id":"xdp2YaVQAVL2iEV8SLBlrbWu5vHXrI86","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725169,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:49;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:2:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:52:49.190693Z\\";s:15:\\"organization_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:52:50
2	7ef275de-6508-435b-b956-2667a426c255	redis	default	{"uuid":"7ef275de-6508-435b-b956-2667a426c255","timeout":null,"id":"c2COOnu7RBPnjsvBFd3JIl6yWBjLw4hy","displayName":"App\\\\Events\\\\DriverStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725169,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:30:\\"App\\\\Events\\\\DriverStatusChanged\\":3:{s:6:\\"driver\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:17:\\"App\\\\Models\\\\Driver\\";s:2:\\"id\\";i:6;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:2:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:52:49.191401Z\\";s:15:\\"organization_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\DriverStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/DriverStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\DriverStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\DriverStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:52:50
3	c364c69a-cd98-41d6-b14c-887f3a8e6238	redis	default	{"uuid":"c364c69a-cd98-41d6-b14c-887f3a8e6238","timeout":null,"id":"12VSvR8F5d1YYEUVLITzPtAUsq2BSpdG","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:49;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:2:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:53:53.277715Z\\";s:15:\\"organization_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:53:54
4	f42c0054-016c-4730-aa04-101bd7f98a77	redis	default	{"uuid":"f42c0054-016c-4730-aa04-101bd7f98a77","timeout":null,"id":"X6EPjU0r5SokC74cSaiQPHxpEGbVMNeM","displayName":"App\\\\Events\\\\DriverStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:30:\\"App\\\\Events\\\\DriverStatusChanged\\":3:{s:6:\\"driver\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:17:\\"App\\\\Models\\\\Driver\\";s:2:\\"id\\";i:6;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:2:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:53:53.278462Z\\";s:15:\\"organization_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\DriverStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/DriverStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\DriverStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\DriverStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:53:54
5	6c4b6905-d14e-4dee-b3dc-cd8b9c51f176	redis	default	{"uuid":"6c4b6905-d14e-4dee-b3dc-cd8b9c51f176","timeout":null,"id":"bX5jzDpHmAU5l2fPnO7XzhFgmmvqOJDy","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:22;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:4:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:53:53.305699Z\\";s:15:\\"organization_id\\";i:1;s:6:\\"reason\\";s:18:\\"assignment_expired\\";s:13:\\"assignment_id\\";i:3;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:53:54
6	c1179196-7f42-4daa-864b-892575e1ad97	redis	default	{"uuid":"c1179196-7f42-4daa-864b-892575e1ad97","timeout":null,"id":"FHGRbc1yM5PmUlGCqewrL9leHRA3DCRP","displayName":"App\\\\Events\\\\DriverStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:30:\\"App\\\\Events\\\\DriverStatusChanged\\":3:{s:6:\\"driver\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:17:\\"App\\\\Models\\\\Driver\\";s:2:\\"id\\";i:6;s:9:\\"relations\\";a:0:{}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:9:\\"available\\";s:8:\\"metadata\\";a:4:{s:10:\\"changed_at\\";s:27:\\"2025-11-09T21:53:53.308343Z\\";s:15:\\"organization_id\\";i:1;s:6:\\"reason\\";s:18:\\"assignment_expired\\";s:13:\\"assignment_id\\";i:3;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\DriverStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/DriverStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\DriverStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\DriverStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-09 22:53:54
7	e94f426f-b356-4eba-9de2-8883467803bb	redis	default	{"uuid":"e94f426f-b356-4eba-9de2-8883467803bb","timeout":null,"id":"Yt7Ml6vNcKpK7BtC4zfRAEufcRpU82pI","displayName":"App\\\\Listeners\\\\ReleaseVehicleAndDriver","backoff":"60","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":3,"createdAt":1762725169,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:36:\\"Illuminate\\\\Events\\\\CallQueuedListener\\":21:{s:5:\\"class\\";s:37:\\"App\\\\Listeners\\\\ReleaseVehicleAndDriver\\";s:6:\\"method\\";s:6:\\"handle\\";s:4:\\"data\\";a:1:{i:0;O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:1;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-09T21:52:49.159363Z\\";s:10:\\"vehicle_id\\";i:49;s:9:\\"driver_id\\";i:6;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:21.246944444444445;s:11:\\"end_mileage\\";i:150000;}}}s:5:\\"tries\\";i:3;s:13:\\"maxExceptions\\";N;s:7:\\"backoff\\";i:60;s:10:\\"retryUntil\\";N;s:7:\\"timeout\\";N;s:13:\\"failOnTimeout\\";b:0;s:17:\\"shouldBeEncrypted\\";b:0;s:3:\\"job\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Events\\\\CallQueuedListener"},"delay":null,"attempts":2}	ErrorException: Undefined property: App\\Events\\AssignmentEnded::$endedBy in /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php:53\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Bootstrap/HandleExceptions.php(258): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->handleError(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#1 /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php(53): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->Illuminate\\Foundation\\Bootstrap\\{closure}(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Events/CallQueuedListener.php(113): App\\Listeners\\ReleaseVehicleAndDriver->handle(Object(App\\Events\\AssignmentEnded))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Events\\CallQueuedListener->handle(Object(Illuminate\\Foundation\\Application))\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Events\\CallQueuedListener), false)\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Events\\CallQueuedListener))\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#28 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#29 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#31 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#36 {main}	2025-11-09 22:54:51
8	4cd96bf5-c007-4e3b-a4f7-6f10dd7d0033	redis	default	{"uuid":"4cd96bf5-c007-4e3b-a4f7-6f10dd7d0033","timeout":null,"id":"Dimc40rx5xTENZmE8rmqgdhkYG9vv2uF","displayName":"App\\\\Listeners\\\\ReleaseVehicleAndDriver","backoff":"60","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":3,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:36:\\"Illuminate\\\\Events\\\\CallQueuedListener\\":21:{s:5:\\"class\\";s:37:\\"App\\\\Listeners\\\\ReleaseVehicleAndDriver\\";s:6:\\"method\\";s:6:\\"handle\\";s:4:\\"data\\";a:1:{i:0;O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:3;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:9:\\"scheduled\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:8:{s:8:\\"ended_at\\";s:27:\\"2025-11-09T21:53:53.308988Z\\";s:10:\\"vehicle_id\\";i:22;s:9:\\"driver_id\\";i:6;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:118;s:11:\\"end_mileage\\";N;s:14:\\"auto_processed\\";b:1;s:12:\\"processed_at\\";s:27:\\"2025-11-09T21:53:53.308919Z\\";}}}s:5:\\"tries\\";i:3;s:13:\\"maxExceptions\\";N;s:7:\\"backoff\\";i:60;s:10:\\"retryUntil\\";N;s:7:\\"timeout\\";N;s:13:\\"failOnTimeout\\";b:0;s:17:\\"shouldBeEncrypted\\";b:0;s:3:\\"job\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Events\\\\CallQueuedListener"},"delay":null,"attempts":2}	ErrorException: Undefined property: App\\Events\\AssignmentEnded::$endedBy in /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php:53\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Bootstrap/HandleExceptions.php(258): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->handleError(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#1 /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php(53): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->Illuminate\\Foundation\\Bootstrap\\{closure}(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Events/CallQueuedListener.php(113): App\\Listeners\\ReleaseVehicleAndDriver->handle(Object(App\\Events\\AssignmentEnded))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Events\\CallQueuedListener->handle(Object(Illuminate\\Foundation\\Application))\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Events\\CallQueuedListener), false)\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Events\\CallQueuedListener))\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#28 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#29 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#31 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#36 {main}	2025-11-09 22:55:54
9	7eb7b0ff-1bd5-4e15-b2a9-2ae0adaa921d	redis	default	{"uuid":"7eb7b0ff-1bd5-4e15-b2a9-2ae0adaa921d","timeout":null,"id":"ZdSywYwIBQ5vrVIFNI2t1B68zYqTtfFY","displayName":"App\\\\Listeners\\\\ReleaseVehicleAndDriver","backoff":"60","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":3,"createdAt":1762725233,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:36:\\"Illuminate\\\\Events\\\\CallQueuedListener\\":21:{s:5:\\"class\\";s:37:\\"App\\\\Listeners\\\\ReleaseVehicleAndDriver\\";s:6:\\"method\\";s:6:\\"handle\\";s:4:\\"data\\";a:1:{i:0;O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:1;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-09T21:53:53.267637Z\\";s:10:\\"vehicle_id\\";i:49;s:9:\\"driver_id\\";i:6;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:21.264722222222225;s:11:\\"end_mileage\\";i:150000;}}}s:5:\\"tries\\";i:3;s:13:\\"maxExceptions\\";N;s:7:\\"backoff\\";i:60;s:10:\\"retryUntil\\";N;s:7:\\"timeout\\";N;s:13:\\"failOnTimeout\\";b:0;s:17:\\"shouldBeEncrypted\\";b:0;s:3:\\"job\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Events\\\\CallQueuedListener"},"delay":null,"attempts":2}	ErrorException: Undefined property: App\\Events\\AssignmentEnded::$endedBy in /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php:53\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Bootstrap/HandleExceptions.php(258): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->handleError(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#1 /var/www/html/app/Listeners/ReleaseVehicleAndDriver.php(53): Illuminate\\Foundation\\Bootstrap\\HandleExceptions->Illuminate\\Foundation\\Bootstrap\\{closure}(2, 'Undefined prope...', '/var/www/html/a...', 53)\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Events/CallQueuedListener.php(113): App\\Listeners\\ReleaseVehicleAndDriver->handle(Object(App\\Events\\AssignmentEnded))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Events\\CallQueuedListener->handle(Object(Illuminate\\Foundation\\Application))\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Events\\CallQueuedListener), false)\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Events\\CallQueuedListener))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Events\\CallQueuedListener))\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#28 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#29 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#31 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#36 {main}	2025-11-09 22:55:54
10	c4c2d972-6f7f-4421-bb04-126259d50d62	redis	default	{"uuid":"c4c2d972-6f7f-4421-bb04-126259d50d62","timeout":null,"id":"0NjAYUMqGxFC4wM8e96Pg4uEp8swsz01","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762911483,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:4;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"affecte\\";s:8:\\"metadata\\";a:7:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T01:38:03.346752Z\\";s:15:\\"organization_id\\";i:1;s:11:\\"test_script\\";s:40:\\"test_vehicle_status_change_ultra_pro.php\\";s:9:\\"timestamp\\";s:25:\\"2025-11-12T02:38:03+01:00\\";s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:26:\\"Test automatique Ultra-Pro\\";s:7:\\"user_id\\";i:3;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 02:38:05
11	971c7285-8e3d-4c12-875f-3ea24f625d76	redis	default	{"uuid":"971c7285-8e3d-4c12-875f-3ea24f625d76","timeout":null,"id":"AUPrra4MThqWj4U8OTftBeHmpGr8sG2i","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762912366,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:49;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:7:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T01:52:46.177140Z\\";s:15:\\"organization_id\\";i:1;s:4:\\"test\\";b:1;s:6:\\"script\\";s:33:\\"test_status_badge_refresh_fix.php\\";s:15:\\"previous_status\\";s:7:\\"affecte\\";s:6:\\"reason\\";s:28:\\"Test rafraîchissement badge\\";s:7:\\"user_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 02:52:47
12	d6833a14-0cb0-4617-aca1-9b2e254a33cd	redis	default	{"uuid":"d6833a14-0cb0-4617-aca1-9b2e254a33cd","timeout":null,"id":"ON2FRbAlXWXFaQ9jZIik3N3mggt4y3c6","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762940917,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:14;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:5:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T09:48:37.861501Z\\";s:15:\\"organization_id\\";i:1;s:15:\\"previous_status\\";s:8:\\"en_panne\\";s:6:\\"reason\\";s:28:\\"Test final après correction\\";s:7:\\"user_id\\";i:1;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 10:48:39
13	5a8a921e-d2a4-4fb1-b5e6-fed54ba5e551	redis	default	{"uuid":"5a8a921e-d2a4-4fb1-b5e6-fed54ba5e551","timeout":null,"id":"wEG9iKQAGjvT3uWQJYP0LReKP4YER2vq","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762941445,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:27;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:8:\\"en_panne\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T09:57:25.223289Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 10:57:26
14	5ad8e359-fc2a-4c87-b10b-0ce9ac35883b	redis	default	{"uuid":"5ad8e359-fc2a-4c87-b10b-0ce9ac35883b","timeout":null,"id":"VJAlUqwotQwNtb02AoMp0vVejDo3WGmk","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762941454,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:42;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:8:\\"en_panne\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T09:57:34.078078Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 10:57:35
15	81e03e9f-e0c2-41e1-bfd4-5e6adf6ec178	redis	default	{"uuid":"81e03e9f-e0c2-41e1-bfd4-5e6adf6ec178","timeout":null,"id":"WVBgecNGBa55aI6Ptr7rDM0sfPfYh3hS","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762941476,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:31;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T09:57:56.044190Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:14:\\"en_maintenance\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 10:57:57
16	7e9ed90f-1647-4acf-893d-847de2dc7fad	redis	default	{"uuid":"7e9ed90f-1647-4acf-893d-847de2dc7fad","timeout":null,"id":"WTty4HLBX8lCB10O6xiofCJ1Bxop887Q","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762945446,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:4;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T11:04:06.026257Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:7:\\"affecte\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 12:04:08
17	0449ad5a-6b30-44c5-8ed1-71047ef47c99	redis	default	{"uuid":"0449ad5a-6b30-44c5-8ed1-71047ef47c99","timeout":null,"id":"eviSizXHQu04rusqq80Z8pRqdRIU87hB","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762952552,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:27;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:02:32.017194Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:8:\\"en_panne\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:02:32
18	6c01992b-50c7-4e5b-afdb-a28ba28f98a0	redis	default	{"uuid":"6c01992b-50c7-4e5b-afdb-a28ba28f98a0","timeout":null,"id":"xWNWPi7eN89U4XMb65nVITZY0cQc5P6m","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762952570,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:42;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"parking\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:02:50.113835Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:8:\\"en_panne\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:02:50
19	9f624378-eda6-449a-8561-f395529eaff1	redis	default	{"uuid":"9f624378-eda6-449a-8561-f395529eaff1","timeout":null,"id":"LsMSMKknAtcnEOF6P91xQJGainnMpGxi","displayName":"App\\\\Events\\\\DriverStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762953166,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:30:\\"App\\\\Events\\\\DriverStatusChanged\\":3:{s:6:\\"driver\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:17:\\"App\\\\Models\\\\Driver\\";s:2:\\"id\\";i:6;s:9:\\"relations\\";a:1:{i:0;s:12:\\"driverStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:10:\\"en_mission\\";s:8:\\"metadata\\";a:6:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:12:46.979662Z\\";s:15:\\"organization_id\\";i:1;s:13:\\"assignment_id\\";i:6;s:15:\\"previous_status\\";s:10:\\"disponible\\";s:6:\\"reason\\";s:37:\\"Affectation #6 du véhicule 105790-16\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\DriverStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/DriverStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\DriverStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\DriverStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:12:48
21	62413740-eed3-417a-b305-178761dd152f	redis	default	{"uuid":"62413740-eed3-417a-b305-178761dd152f","timeout":null,"id":"nnVfQJbIpGOWG4MqVN11CgXRQLLVnnV4","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762953265,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:6;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"affecte\\";s:8:\\"metadata\\";a:6:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:14:25.771190Z\\";s:15:\\"organization_id\\";i:1;s:13:\\"assignment_id\\";i:7;s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:41:\\"Affectation #7 au chauffeur Said merbouhi\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:14:28
20	27e16d4b-5137-43b8-9fa9-9f1cd8b72afa	redis	default	{"uuid":"27e16d4b-5137-43b8-9fa9-9f1cd8b72afa","timeout":null,"id":"ESEtH7B0p5qLJrFu9KI2GGtvjNDH1laY","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762953166,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:26;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:7:\\"affecte\\";s:8:\\"metadata\\";a:6:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:12:46.962081Z\\";s:15:\\"organization_id\\";i:1;s:13:\\"assignment_id\\";i:6;s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:44:\\"Affectation #6 au chauffeur zerrouk ALIOUANE\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:12:48
22	f35e654e-afa0-4c22-acc4-1154ea899515	redis	default	{"uuid":"f35e654e-afa0-4c22-acc4-1154ea899515","timeout":null,"id":"ta96UiKeK7wVPLn7nU3cjLBGSbhtQsdS","displayName":"App\\\\Events\\\\DriverStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762953265,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:30:\\"App\\\\Events\\\\DriverStatusChanged\\":3:{s:6:\\"driver\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:17:\\"App\\\\Models\\\\Driver\\";s:2:\\"id\\";i:8;s:9:\\"relations\\";a:1:{i:0;s:12:\\"driverStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:10:\\"en_mission\\";s:8:\\"metadata\\";a:6:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T13:14:25.784655Z\\";s:15:\\"organization_id\\";i:1;s:13:\\"assignment_id\\";i:7;s:15:\\"previous_status\\";s:10:\\"disponible\\";s:6:\\"reason\\";s:37:\\"Affectation #7 du véhicule 186125-16\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\DriverStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/DriverStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\DriverStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\DriverStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 14:14:28
23	1b41ffba-2c3b-40e7-ad72-4fa6cab7c006	redis	default	{"uuid":"1b41ffba-2c3b-40e7-ad72-4fa6cab7c006","timeout":null,"id":"LNEEpLtjlnBvpXuPz6fsJNf5s1OUYc42","displayName":"App\\\\Events\\\\VehicleStatusChanged","backoff":null,"job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"createdAt":1762962807,"failOnTimeout":false,"maxExceptions":null,"retryUntil":null,"data":{"command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:31:\\"App\\\\Events\\\\VehicleStatusChanged\\":3:{s:7:\\"vehicle\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:18:\\"App\\\\Models\\\\Vehicle\\";s:2:\\"id\\";i:27;s:9:\\"relations\\";a:1:{i:0;s:13:\\"vehicleStatus\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:9:\\"newStatus\\";s:8:\\"en_panne\\";s:8:\\"metadata\\";a:9:{s:10:\\"changed_at\\";s:27:\\"2025-11-12T15:53:27.625484Z\\";s:15:\\"organization_id\\";i:1;s:2:\\"ip\\";s:10:\\"172.18.0.1\\";s:10:\\"user_agent\\";s:111:\\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36\\";s:9:\\"component\\";s:26:\\"VehicleStatusBadgeUltraPro\\";s:6:\\"source\\";s:5:\\"badge\\";s:15:\\"previous_status\\";s:7:\\"parking\\";s:6:\\"reason\\";s:37:\\"Changement manuel via badge de statut\\";s:7:\\"user_id\\";i:4;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}","commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent"},"delay":null,"attempts":2}	Error: Typed property App\\Events\\VehicleStatusChanged::$fromStatus must not be accessed before initialization in /var/www/html/app/Events/VehicleStatusChanged.php:90\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(110): App\\Events\\VehicleStatusChanged->broadcastWith()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Broadcasting/BroadcastEvent.php(90): Illuminate\\Broadcasting\\BroadcastEvent->getPayloadFromEvent(Object(App\\Events\\VehicleStatusChanged))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Broadcasting\\BroadcastEvent->handle(Object(Illuminate\\Broadcasting\\BroadcastManager))\n#3 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(132): Illuminate\\Container\\Container->call(Array)\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Bus\\Dispatcher->Illuminate\\Bus\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Bus/Dispatcher.php(136): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(134): Illuminate\\Bus\\Dispatcher->dispatchNow(Object(Illuminate\\Broadcasting\\BroadcastEvent), false)\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Queue\\CallQueuedHandler->Illuminate\\Queue\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(137): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(127): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(68): Illuminate\\Queue\\CallQueuedHandler->dispatchThroughMiddleware(Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Broadcasting\\BroadcastEvent))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#18 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#20 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#21 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#22 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#24 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#25 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#26 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#27 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#28 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#29 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#30 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#31 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#32 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#33 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#34 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#35 {main}	2025-11-12 16:53:29
24	0663ccc8-1e3e-4d52-9abd-bbbf449dbd2e	redis	default	{"uuid":"0663ccc8-1e3e-4d52-9abd-bbbf449dbd2e","displayName":"App\\\\Listeners\\\\ReleaseVehicleAndDriver","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":3,"maxExceptions":null,"failOnTimeout":false,"backoff":"60","timeout":null,"retryUntil":null,"data":{"commandName":"Illuminate\\\\Events\\\\CallQueuedListener","command":"O:36:\\"Illuminate\\\\Events\\\\CallQueuedListener\\":21:{s:5:\\"class\\";s:37:\\"App\\\\Listeners\\\\ReleaseVehicleAndDriver\\";s:6:\\"method\\";s:6:\\"handle\\";s:4:\\"data\\";a:1:{i:0;O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:8;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-12T21:59:19.630650Z\\";s:10:\\"vehicle_id\\";i:39;s:9:\\"driver_id\\";i:8;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:0.08333333333333333;s:11:\\"end_mileage\\";N;}}}s:5:\\"tries\\";i:3;s:13:\\"maxExceptions\\";N;s:7:\\"backoff\\";i:60;s:10:\\"retryUntil\\";N;s:7:\\"timeout\\";N;s:13:\\"failOnTimeout\\";b:0;s:17:\\"shouldBeEncrypted\\";b:0;s:3:\\"job\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}"},"createdAt":1762984759,"id":"Vz9FRVruL8huYvIPHeCgvbdI5PiCjOsV","attempts":0,"delay":null}	Illuminate\\Database\\Eloquent\\ModelNotFoundException: No query results for model [App\\Models\\Assignment]. in /var/www/html/vendor/laravel/framework/src/Illuminate/Database/Eloquent/Builder.php:765\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(110): Illuminate\\Database\\Eloquent\\Builder->firstOrFail()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(63): App\\Events\\AssignmentEnded->restoreModel(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesModels.php(97): App\\Events\\AssignmentEnded->getRestoredPropertyValue(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#3 [internal function]: App\\Events\\AssignmentEnded->__unserialize(Array)\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(95): unserialize('O:36:"Illuminat...')\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(62): Illuminate\\Queue\\CallQueuedHandler->getCommand(Array)\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#18 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#20 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#21 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#22 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#24 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#25 {main}	2025-11-12 22:59:20
25	7c3ad975-2fa5-44dc-bb54-84e294de58b3	redis	default	{"uuid":"7c3ad975-2fa5-44dc-bb54-84e294de58b3","displayName":"App\\\\Events\\\\AssignmentEnded","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"maxExceptions":null,"failOnTimeout":false,"backoff":null,"timeout":null,"retryUntil":null,"data":{"commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent","command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:8;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-12T21:59:19.630650Z\\";s:10:\\"vehicle_id\\";i:39;s:9:\\"driver_id\\";i:8;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:0.08333333333333333;s:11:\\"end_mileage\\";N;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}"},"createdAt":1762984759,"id":"GyDMYUOsOABUnluAh3enaTJtmnqwQdUz","attempts":0,"delay":null}	Illuminate\\Database\\Eloquent\\ModelNotFoundException: No query results for model [App\\Models\\Assignment]. in /var/www/html/vendor/laravel/framework/src/Illuminate/Database/Eloquent/Builder.php:765\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(110): Illuminate\\Database\\Eloquent\\Builder->firstOrFail()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(63): App\\Events\\AssignmentEnded->restoreModel(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesModels.php(97): App\\Events\\AssignmentEnded->getRestoredPropertyValue(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#3 [internal function]: App\\Events\\AssignmentEnded->__unserialize(Array)\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(95): unserialize('O:38:"Illuminat...')\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(62): Illuminate\\Queue\\CallQueuedHandler->getCommand(Array)\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#18 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#20 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#21 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#22 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#24 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#25 {main}	2025-11-12 22:59:20
26	a8ecbe64-f5bf-495f-99ab-556cf5668304	redis	default	{"uuid":"a8ecbe64-f5bf-495f-99ab-556cf5668304","displayName":"App\\\\Events\\\\AssignmentEnded","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":null,"maxExceptions":null,"failOnTimeout":false,"backoff":null,"timeout":null,"retryUntil":null,"data":{"commandName":"Illuminate\\\\Broadcasting\\\\BroadcastEvent","command":"O:38:\\"Illuminate\\\\Broadcasting\\\\BroadcastEvent\\":15:{s:5:\\"event\\";O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:10;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-12T21:59:43.336408Z\\";s:10:\\"vehicle_id\\";i:39;s:9:\\"driver_id\\";i:8;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:0.08333333333333333;s:11:\\"end_mileage\\";N;}}s:5:\\"tries\\";N;s:7:\\"timeout\\";N;s:7:\\"backoff\\";N;s:13:\\"maxExceptions\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}"},"createdAt":1762984783,"id":"5hmoEedG5BpD8g5aOR2zgsT5hxO6cOyu","attempts":0,"delay":null}	Illuminate\\Database\\Eloquent\\ModelNotFoundException: No query results for model [App\\Models\\Assignment]. in /var/www/html/vendor/laravel/framework/src/Illuminate/Database/Eloquent/Builder.php:765\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(110): Illuminate\\Database\\Eloquent\\Builder->firstOrFail()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(63): App\\Events\\AssignmentEnded->restoreModel(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesModels.php(97): App\\Events\\AssignmentEnded->getRestoredPropertyValue(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#3 [internal function]: App\\Events\\AssignmentEnded->__unserialize(Array)\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(95): unserialize('O:38:"Illuminat...')\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(62): Illuminate\\Queue\\CallQueuedHandler->getCommand(Array)\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#18 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#20 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#21 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#22 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#24 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#25 {main}	2025-11-12 22:59:43
27	2a9a4032-b68d-4181-8fb6-b22ebc587a2b	redis	default	{"uuid":"2a9a4032-b68d-4181-8fb6-b22ebc587a2b","displayName":"App\\\\Listeners\\\\ReleaseVehicleAndDriver","job":"Illuminate\\\\Queue\\\\CallQueuedHandler@call","maxTries":3,"maxExceptions":null,"failOnTimeout":false,"backoff":"60","timeout":null,"retryUntil":null,"data":{"commandName":"Illuminate\\\\Events\\\\CallQueuedListener","command":"O:36:\\"Illuminate\\\\Events\\\\CallQueuedListener\\":21:{s:5:\\"class\\";s:37:\\"App\\\\Listeners\\\\ReleaseVehicleAndDriver\\";s:6:\\"method\\";s:6:\\"handle\\";s:4:\\"data\\";a:1:{i:0;O:26:\\"App\\\\Events\\\\AssignmentEnded\\":4:{s:10:\\"assignment\\";O:45:\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\":5:{s:5:\\"class\\";s:21:\\"App\\\\Models\\\\Assignment\\";s:2:\\"id\\";i:10;s:9:\\"relations\\";a:2:{i:0;s:7:\\"vehicle\\";i:1;s:6:\\"driver\\";}s:10:\\"connection\\";s:5:\\"pgsql\\";s:15:\\"collectionClass\\";N;}s:7:\\"endType\\";s:6:\\"manual\\";s:6:\\"userId\\";N;s:8:\\"metadata\\";a:6:{s:8:\\"ended_at\\";s:27:\\"2025-11-12T21:59:43.336408Z\\";s:10:\\"vehicle_id\\";i:39;s:9:\\"driver_id\\";i:8;s:15:\\"organization_id\\";i:1;s:14:\\"duration_hours\\";d:0.08333333333333333;s:11:\\"end_mileage\\";N;}}}s:5:\\"tries\\";i:3;s:13:\\"maxExceptions\\";N;s:7:\\"backoff\\";i:60;s:10:\\"retryUntil\\";N;s:7:\\"timeout\\";N;s:13:\\"failOnTimeout\\";b:0;s:17:\\"shouldBeEncrypted\\";b:0;s:3:\\"job\\";N;s:10:\\"connection\\";N;s:5:\\"queue\\";N;s:12:\\"messageGroup\\";N;s:5:\\"delay\\";N;s:11:\\"afterCommit\\";N;s:10:\\"middleware\\";a:0:{}s:7:\\"chained\\";a:0:{}s:15:\\"chainConnection\\";N;s:10:\\"chainQueue\\";N;s:19:\\"chainCatchCallbacks\\";N;}"},"createdAt":1762984783,"id":"i26xkYhUL3GAQLzoSbtWoJyfyjPm5VJ5","attempts":0,"delay":null}	Illuminate\\Database\\Eloquent\\ModelNotFoundException: No query results for model [App\\Models\\Assignment]. in /var/www/html/vendor/laravel/framework/src/Illuminate/Database/Eloquent/Builder.php:765\nStack trace:\n#0 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(110): Illuminate\\Database\\Eloquent\\Builder->firstOrFail()\n#1 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesAndRestoresModelIdentifiers.php(63): App\\Events\\AssignmentEnded->restoreModel(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#2 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/SerializesModels.php(97): App\\Events\\AssignmentEnded->getRestoredPropertyValue(Object(Illuminate\\Contracts\\Database\\ModelIdentifier))\n#3 [internal function]: App\\Events\\AssignmentEnded->__unserialize(Array)\n#4 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(95): unserialize('O:36:"Illuminat...')\n#5 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/CallQueuedHandler.php(62): Illuminate\\Queue\\CallQueuedHandler->getCommand(Array)\n#6 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Jobs/Job.php(102): Illuminate\\Queue\\CallQueuedHandler->call(Object(Illuminate\\Queue\\Jobs\\RedisJob), Array)\n#7 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(444): Illuminate\\Queue\\Jobs\\Job->fire()\n#8 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(394): Illuminate\\Queue\\Worker->process('redis', Object(Illuminate\\Queue\\Jobs\\RedisJob), Object(Illuminate\\Queue\\WorkerOptions))\n#9 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Worker.php(180): Illuminate\\Queue\\Worker->runJob(Object(Illuminate\\Queue\\Jobs\\RedisJob), 'redis', Object(Illuminate\\Queue\\WorkerOptions))\n#10 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(148): Illuminate\\Queue\\Worker->daemon('redis', 'default', Object(Illuminate\\Queue\\WorkerOptions))\n#11 /var/www/html/vendor/laravel/framework/src/Illuminate/Queue/Console/WorkCommand.php(131): Illuminate\\Queue\\Console\\WorkCommand->runWorker('redis', 'default')\n#12 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(36): Illuminate\\Queue\\Console\\WorkCommand->handle()\n#13 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Util.php(43): Illuminate\\Container\\BoundMethod::Illuminate\\Container\\{closure}()\n#14 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(96): Illuminate\\Container\\Util::unwrapIfClosure(Object(Closure))\n#15 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/BoundMethod.php(35): Illuminate\\Container\\BoundMethod::callBoundMethod(Object(Illuminate\\Foundation\\Application), Array, Object(Closure))\n#16 /var/www/html/vendor/laravel/framework/src/Illuminate/Container/Container.php(836): Illuminate\\Container\\BoundMethod::call(Object(Illuminate\\Foundation\\Application), Array, Array, NULL)\n#17 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(211): Illuminate\\Container\\Container->call(Array)\n#18 /var/www/html/vendor/symfony/console/Command/Command.php(318): Illuminate\\Console\\Command->execute(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#19 /var/www/html/vendor/laravel/framework/src/Illuminate/Console/Command.php(180): Symfony\\Component\\Console\\Command\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Illuminate\\Console\\OutputStyle))\n#20 /var/www/html/vendor/symfony/console/Application.php(1110): Illuminate\\Console\\Command->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#21 /var/www/html/vendor/symfony/console/Application.php(359): Symfony\\Component\\Console\\Application->doRunCommand(Object(Illuminate\\Queue\\Console\\WorkCommand), Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#22 /var/www/html/vendor/symfony/console/Application.php(194): Symfony\\Component\\Console\\Application->doRun(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#23 /var/www/html/vendor/laravel/framework/src/Illuminate/Foundation/Console/Kernel.php(197): Symfony\\Component\\Console\\Application->run(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#24 /var/www/html/artisan(35): Illuminate\\Foundation\\Console\\Kernel->handle(Object(Symfony\\Component\\Console\\Input\\ArgvInput), Object(Symfony\\Component\\Console\\Output\\ConsoleOutput))\n#25 {main}	2025-11-12 22:59:43
\.
...
107	2025_11_08_014153_fix_vehicles_status_column_remove_default	41
108	2025_11_08_020000_optimize_postgresql_configuration	42
109	2025_11_08_020100_partition_expense_audit_logs	42
111	2025_11_08_000001_update_vehicle_statuses_with_new_enum_values	43
112	2025_11_08_000002_update_vehicle_types_with_new_enum_values	44
113	2025_11_08_000003_create_status_history_table	45
114	2025_11_08_020200_add_strategic_indexes	46
115	2025_11_08_000004_update_driver_statuses_with_new_enum_values	47
116	2025_11_09_000001_add_availability_fields_to_vehicles_and_drivers	48
117	2025_11_11_enhance_vehicle_depots_enterprise	49
118	2025_11_12_migrate_actif_inactif_to_parking	50
\.


--
-- Data for Name: mileage_histories; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.mileage_histories (id, vehicle_id, driver_id, assignment_id, mileage_value, recorded_at, type, notes, created_by, organization_id, created_at, updated_at) FROM stdin;
2	49	6	\N	150000	2025-11-09 22:53:53	assignment_end	Kilométrage de fin d'affectation	\N	1	2025-11-09 22:53:53	2025-11-09 22:53:53
\.
...
259	update-vehicle-status	web	2025-11-08 11:07:33	2025-11-08 11:07:33	\N
260	update-driver-status	web	2025-11-08 11:07:33	2025-11-08 11:07:33	\N
261	view-status-history	web	2025-11-08 11:07:33	2025-11-08 11:07:33	\N
262	view-all-status-history	web	2025-11-08 11:07:33	2025-11-08 11:07:33	\N
263	bulk-update-vehicle-status	web	2025-11-08 11:07:33	2025-11-08 11:07:33	\N
\.
...
--
-- Data for Name: status_histories; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.status_histories (id, entity_type, entity_id, organization_id, old_status, new_status, reason, metadata, changed_by, changed_at, ip_address, user_agent) FROM stdin;
1	vehicles	2	1	parking	en_maintenance	\N	{}	\N	2025-11-07 21:52:55.345401	\N	\N
3	vehicles	3	1	parking	affecté	\N	[]	\N	2025-11-07 22:30:39.033135	\N	\N
4	vehicle	3	1	parking	affecté	Test de transition	[]	\N	2025-11-07 23:30:39	127.0.0.1	Symfony
5	vehicle	3	1	affecté	affecté	Test de transition	[]	\N	2025-11-07 23:31:51	127.0.0.1	Symfony
6	vehicles	5	1	parking	en_maintenance	\N	[]	\N	2025-11-07 22:48:36.286835	\N	\N
7	vehicle	5	1	parking	en_maintenance	Test transition	[]	\N	2025-11-07 23:48:36	127.0.0.1	Symfony
\.


--
-- Data for Name: status_history; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.status_history (id, statusable_type, statusable_id, from_status, to_status, reason, metadata, changed_by_user_id, change_type, ip_address, user_agent, organization_id, changed_at, created_at, updated_at) FROM stdin;
1	App\\Models\\Vehicle	22	\N	parking	Test transition automatique	\N	\N	manual	127.0.0.1	Symfony	1	2025-11-08 11:00:04	2025-11-08 11:00:04	2025-11-08 11:00:04
2	App\\Models\\Vehicle	22	parking	en_panne	Panne moteur détectée	{"severity":"high"}	\N	manual	127.0.0.1	Symfony	1	2025-11-08 11:00:15	2025-11-08 11:00:15	2025-11-08 11:00:15
3	App\\Models\\Vehicle	49	parking	affecte	Test affectation #1	\N	4	manual	127.0.0.1	Symfony	1	2025-11-08 23:38:26	2025-11-08 23:38:26	2025-11-08 23:38:26
4	App\\Models\\Driver	6	disponible	en_mission	Test affectation #1	\N	4	manual	127.0.0.1	Symfony	1	2025-11-08 23:38:26	2025-11-08 23:38:26	2025-11-08 23:38:26
5	App\\Models\\Vehicle	7	parking	affecte	Affectation #2 au chauffeur Said merbouhi	{"assignment_id":2}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-08 23:43:56	2025-11-08 23:43:56	2025-11-08 23:43:56
6	App\\Models\\Driver	8	disponible	en_mission	Affectation #2 du véhicule 211523-16	{"assignment_id":2}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-08 23:43:56	2025-11-08 23:43:56	2025-11-08 23:43:56
17	App\\Models\\Vehicle	4	parking	affecte	Test automatique Ultra-Pro	{"test_script":"test_vehicle_status_change_ultra_pro.php","timestamp":"2025-11-12T02:38:03+01:00"}	3	manual	127.0.0.1	Symfony	1	2025-11-12 02:38:03	2025-11-12 02:38:03	2025-11-12 02:38:03
26	App\\Models\\Vehicle	49	affecte	parking	Test rafraîchissement badge	{"test":true,"script":"test_status_badge_refresh_fix.php"}	1	manual	127.0.0.1	Symfony	1	2025-11-12 02:52:46	2025-11-12 02:52:46	2025-11-12 02:52:46
41	App\\Models\\Vehicle	27	parking	en_panne	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 10:57:25	2025-11-12 10:57:25	2025-11-12 10:57:25
42	App\\Models\\Vehicle	42	parking	en_panne	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 10:57:34	2025-11-12 10:57:34	2025-11-12 10:57:34
43	App\\Models\\Vehicle	31	en_maintenance	parking	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 10:57:56	2025-11-12 10:57:56	2025-11-12 10:57:56
44	App\\Models\\Vehicle	4	affecte	parking	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 12:04:06	2025-11-12 12:04:06	2025-11-12 12:04:06
45	App\\Models\\Vehicle	27	en_panne	parking	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:02:32	2025-11-12 14:02:32	2025-11-12 14:02:32
46	App\\Models\\Vehicle	42	en_panne	parking	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:02:50	2025-11-12 14:02:50	2025-11-12 14:02:50
47	App\\Models\\Vehicle	26	parking	affecte	Affectation #6 au chauffeur zerrouk ALIOUANE	{"assignment_id":6}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:12:46	2025-11-12 14:12:46	2025-11-12 14:12:46
48	App\\Models\\Driver	6	disponible	en_mission	Affectation #6 du véhicule 105790-16	{"assignment_id":6}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:12:46	2025-11-12 14:12:46	2025-11-12 14:12:46
49	App\\Models\\Vehicle	6	parking	affecte	Affectation #7 au chauffeur Said merbouhi	{"assignment_id":7}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:14:25	2025-11-12 14:14:25	2025-11-12 14:14:25
50	App\\Models\\Driver	8	disponible	en_mission	Affectation #7 du véhicule 186125-16	{"assignment_id":7}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 14:14:25	2025-11-12 14:14:25	2025-11-12 14:14:25
51	App\\Models\\Vehicle	27	parking	en_panne	Changement manuel via badge de statut	{"ip":"172.18.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.18.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 16:53:27	2025-11-12 16:53:27	2025-11-12 16:53:27
52	App\\Models\\Vehicle	6	affecte	parking	Changement manuel via badge de statut	{"ip":"172.19.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-12 20:29:15	2025-11-12 20:29:15	2025-11-12 20:29:15
53	App\\Models\\Vehicle	26	affecte	parking	Changement manuel via badge de statut	{"ip":"172.19.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 13:14:22	2025-11-13 13:14:22	2025-11-13 13:14:22
54	App\\Models\\Vehicle	6	affecte	parking	Changement manuel via badge de statut	{"ip":"172.19.0.1","user_agent":"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/142.0.0.0 Safari\\/537.36","component":"VehicleStatusBadgeUltraPro","source":"badge"}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 13:14:31	2025-11-13 13:14:31	2025-11-13 13:14:31
55	App\\Models\\Vehicle	22	parking	affecte	Affectation #12 au chauffeur Said merbouhi	{"assignment_id":12}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 13:17:34	2025-11-13 13:17:34	2025-11-13 13:17:34
56	App\\Models\\Driver	8	disponible	en_mission	Affectation #12 du véhicule 118910-16	{"assignment_id":12}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 13:17:35	2025-11-13 13:17:35	2025-11-13 13:17:35
57	App\\Models\\Vehicle	26	parking	affecte	Affectation #13 au chauffeur Said merbouhi	{"assignment_id":13}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 20:41:41	2025-11-13 20:41:41	2025-11-13 20:41:41
58	App\\Models\\Driver	8	disponible	en_mission	Affectation #13 du véhicule 105790-16	{"assignment_id":13}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 20:41:41	2025-11-13 20:41:41	2025-11-13 20:41:41
59	App\\Models\\Vehicle	26	parking	affecte	Affectation #14 au chauffeur Said merbouhi	{"assignment_id":14}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 23:03:51	2025-11-13 23:03:51	2025-11-13 23:03:51
60	App\\Models\\Driver	8	disponible	en_mission	Affectation #14 du véhicule 105790-16	{"assignment_id":14}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 23:03:51	2025-11-13 23:03:51	2025-11-13 23:03:51
61	App\\Models\\Vehicle	22	parking	affecte	Affectation #16 au chauffeur Said merbouhi	{"assignment_id":16}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 23:26:11	2025-11-13 23:26:11	2025-11-13 23:26:11
62	App\\Models\\Driver	8	disponible	en_mission	Affectation #16 du véhicule 118910-16	{"assignment_id":16}	4	manual	172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36	1	2025-11-13 23:26:11	2025-11-13 23:26:11	2025-11-13 23:26:11
\.


--
-- Data for Name: status_transition_rules; Type: TABLE DATA; Schema: public; Owner: zenfleet_user
--

COPY public.status_transition_rules (id, entity_type, from_status, to_status, requires_approval, approval_role, conditions, is_active, created_at, updated_at) FROM stdin;
1	vehicle	parking	affecté	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
2	vehicle	parking	en_maintenance	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
3	vehicle	affecté	parking	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
4	vehicle	affecté	en_panne	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
5	vehicle	affecté	en_maintenance	t	fleet_manager	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
6	vehicle	en_panne	en_maintenance	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
7	vehicle	en_panne	reformé	t	fleet_manager	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
8	vehicle	en_maintenance	parking	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
9	vehicle	en_maintenance	affecté	f	\N	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
10	vehicle	en_maintenance	reformé	t	fleet_manager	\N	t	2025-11-07 21:33:55.9427	2025-11-07 21:33:55.9427
11	driver	disponible	en_mission	f	\N	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
12	driver	disponible	en_congé	f	\N	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
13	driver	disponible	autre	t	hr_manager	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
14	driver	en_mission	disponible	f	\N	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
15	driver	en_mission	en_congé	t	hr_manager	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
16	driver	en_mission	autre	t	hr_manager	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
17	driver	en_congé	disponible	f	\N	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
18	driver	autre	disponible	t	hr_manager	\N	t	2025-11-07 21:33:55.945962	2025-11-07 21:33:55.945962
\.
...
COPY public.vehicle_depots (id, organization_id, name, code, address, city, wilaya, postal_code, phone, manager_name, manager_phone, capacity, current_count, latitude, longitude, is_active, created_at, updated_at, deleted_at, email, description, type, status, state_province, country_code, timezone, operating_hours, manager_email, current_occupancy, utilization_rate, coverage_radius_km, polygon_boundaries, facilities, services, certifications, metadata, iot_config, has_fuel_station, has_wash_station, has_maintenance_facility, has_charging_stations, charging_stations_count, is_public, monthly_cost, cost_currency, opened_at, last_inspection_at, next_inspection_at) FROM stdin;
12	1	DEPOT_TEST_Minimal	D-DEP-251111-93D0	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	t	2025-11-05 16:08:14	2025-11-06 00:12:17	2025-11-06 00:12:17	\N	\N	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	0	0.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
6	1	Dépôt Test Code NULL	D-CON-251111-79BA	\N	Constantine	Constantine	\N	\N	\N	\N	25	0	\N	\N	f	2025-11-05 11:53:06	2025-11-05 11:53:06	\N	\N	\N	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	0	0.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
16	1	Dépôt DG	DP0002	Zone industrielle reghaia	Reghaia	Alger		023658902	El hadi Chemli	0770 34 67 81	100	8	\N	\N	t	2025-11-05 20:30:03	2025-11-12 02:56:09	\N	depot-principal@zenfleet.com	Direction Générale	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	5	5.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
5	1	Auto-Généré	DP0001	\N	Oran	Oran	\N	\N	\N	\N	30	7	\N	\N	t	2025-11-05 11:53:06	2025-11-12 02:56:09	\N	\N	\N	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	6	20.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
14	1	DEPOT_TEST_Modifié	CUSTOM-001	123 Boulevard de la République	Alger	Alger	16000	+213 555 0100	Ahmed Benali	+213 555 0101	150	0	36.75380000	3.05880000	f	2025-11-05 16:08:14	2025-11-05 20:30:52	\N	nouveau.email@zenfleet.com	Dépôt principal de la flotte ZenFleet à Alger	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	0	0.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
4	1	Dépôt Test Personnalisé	TEST-001	\N	Alger	Alger	\N	\N	\N	\N	50	0	\N	\N	t	2025-11-05 11:53:06	2025-11-05 20:31:11	\N	\N	\N	main	active	\N	DZ	Africa/Algiers	{"monday":{"open":"08:00","close":"18:00"},"tuesday":{"open":"08:00","close":"18:00"},"wednesday":{"open":"08:00","close":"18:00"},"thursday":{"open":"08:00","close":"18:00"},"friday":{"open":"08:00","close":"18:00"},"saturday":{"open":"08:00","close":"13:00"},"sunday":{"open":null,"close":null}}	\N	0	0.00	\N	\N	\N	\N	\N	\N	\N	f	f	f	f	0	f	\N	DZD	\N	\N	\N
\.
...
COPY public.vehicle_statuses (id, name, slug, description, color, icon, is_active, sort_order, can_be_assigned, is_operational, requires_maintenance, organization_id, created_at, updated_at) FROM stdin;
8	Parking	parking	Véhicule disponible au parking, prêt pour affectation	#3b82f6	fa-parking	t	1	t	t	f	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
9	Affecté	affecte	Véhicule affecté à un chauffeur, en service	#10b981	fa-user-check	t	2	f	t	f	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
10	En panne	en_panne	Véhicule en panne, nécessite intervention technique	#ef4444	fa-exclamation-triangle	t	3	f	f	t	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
2	En maintenance	en_maintenance	Véhicule en cours de réparation chez le réparateur	#f59e0b	fa-wrench	t	4	f	f	t	\N	\N	2025-11-08 10:59:26
11	Réformé	reforme	Véhicule réformé, hors service définitif	#6b7280	fa-archive	f	5	f	f	f	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
\.
...
COPY public.vehicle_types (id, name, slug, description, color, icon, is_active, sort_order, requires_special_license, required_license_category, maintenance_cost_level, average_capacity_tons, organization_id, created_at, updated_at) FROM stdin;
1	Berline	berline	\N	#6b7280	fa-car	t	0	f	\N	3	\N	\N	\N	2025-11-08 10:59:26
2	Utilitaire	utilitaire	\N	#6b7280	fa-car	t	0	f	\N	3	\N	\N	\N	2025-11-08 10:59:26
5	Voiture	voiture	Voiture de tourisme ou véhicule utilitaire léger	#3b82f6	fa-car	t	1	f	B	2	0.50	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
3	Camion	camion	Camion ou poids lourd pour transport de marchandises	#8b5cf6	fa-truck	t	5	t	C	4	12.00	\N	\N	2025-11-08 10:59:26
6	Moto	moto	Moto, scooter ou deux-roues motorisé	#10b981	fa-motorcycle	t	2	f	A	2	0.20	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
7	Engin	engin	Engin spécialisé : construction, BTP, agriculture	#f59e0b	fa-tractor	t	8	t	CACES	5	\N	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
8	Fourgonnette	fourgonnette	Fourgonnette ou van utilitaire	#6366f1	fa-shuttle-van	t	4	f	B	3	2.00	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
4	Bus	bus	Bus ou minibus pour transport collectif de personnes	#ec4899	fa-bus	t	7	t	D	4	\N	\N	\N	2025-11-08 10:59:26
9	VUL	vul	Véhicule utilitaire léger (VUL)	#06b6d4	fa-truck-moving	t	3	f	B	3	1.50	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
10	Semi-remorque	semi_remorque	Semi-remorque ou camion avec remorque	#f97316	fa-trailer	t	6	t	CE	5	24.00	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
11	Autre	autre	Autre type de véhicule non catégorisé	#6b7280	fa-question-circle	t	9	f	\N	3	\N	\N	2025-11-08 10:59:26	2025-11-08 10:59:26
\.
...
COPY public.vehicles (id, registration_plate, vin, brand, model, color, vehicle_type_id, fuel_type_id, transmission_type_id, status_id, manufacturing_year, acquisition_date, purchase_price, current_value, initial_mileage, current_mileage, engine_displacement_cc, power_hp, seats, status_reason, notes, created_at, updated_at, deleted_at, organization_id, vehicle_name, category_id, depot_id, is_archived, status, status_metadata, status_changed_at, status_changed_by, is_available, current_driver_id, assignment_status, last_assignment_end) FROM stdin;
39	229061-16	VF190008N8V498668	Isuzu	D-Max	Noir	1	1	1	8	2014	2020-01-10	2281958.00	\N	97397	97397	\N	\N	45	\N	\N	2024-11-23 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
41	150814-16	VF182392P9M760516	Peugeot	Partner	Blanc	1	1	1	8	2017	2022-11-24	4414238.00	\N	68602	68602	\N	\N	7	\N	\N	2024-11-03 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
43	523994-16	VF104636J1H427908	Toyota	Corolla	Gris	1	1	1	8	2011	2017-12-07	3108634.00	\N	258894	258894	\N	\N	7	\N	\N	2024-11-13 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
35	755406-16	VF102904A6Y492551	Isuzu	NQR	Bleu	1	1	1	8	2015	2018-12-01	2308393.00	\N	107746	107746	\N	\N	20	\N	Voluptate corporis vitae vel et et non deleniti ut.	2025-08-16 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
32	444209-16	VF161893Z7I905567	Isuzu	FTR	Gris	1	1	1	8	2012	2024-02-20	2423649.00	\N	285115	285115	\N	\N	5	\N	\N	2025-09-30 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
13	284139-16	VF102635T7E415988	Mercedes	A-Class	Rouge	1	1	1	8	2017	2023-11-23	2260240.00	\N	113438	123408	\N	\N	12	\N	\N	2025-04-04 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
40	795626-16	VF184869Z5A458448	Ford	Fiesta	Blanc	1	1	1	8	2017	2021-05-04	2411585.00	\N	253860	253860	\N	\N	7	\N	\N	2025-05-12 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	5	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
44	613014-16	VF172554F1J546405	Mercedes	Vito	Blanc	1	1	1	8	2017	2024-11-25	3003332.00	\N	213605	213605	\N	\N	12	\N	\N	2024-11-15 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
45	130672-16	VF142419L6D253814	Renault	Logan	Bleu	1	1	1	8	2014	2021-03-02	2496769.00	\N	55431	55431	\N	\N	45	\N	\N	2025-03-21 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
51	835292-16	VF178699S8F508211	Mercedes	Sprinter	Rouge	1	1	1	8	2021	2024-08-16	4466866.00	\N	274590	274590	\N	\N	12	\N	Dignissimos est enim aliquam quisquam.	2024-10-27 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
54	377545-16	VF120478Y6E909205	Peugeot	301	Bleu	1	1	1	8	2010	2017-05-25	3404580.00	\N	128534	128534	\N	\N	20	\N	Consequatur corporis ex debitis est voluptatem voluptatum.	2025-04-02 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
46	611824-16	VF107903C8Y268423	Iveco	Stralis	Blanc	1	1	1	8	2024	2025-10-11	2389539.00	\N	166050	166050	\N	\N	45	\N	\N	2025-09-27 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
56	869897-16	VF167582Y5S811254	Isuzu	D-Max	Bleu	1	1	1	8	2011	2017-12-15	1773162.00	\N	151614	151614	\N	\N	45	\N	\N	2025-08-14 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
8	301401-16	VF141058T9T841124	Renault	Logan	Bleu	1	1	1	8	2010	2019-05-08	2451085.00	\N	70324	71000	\N	\N	20	\N	Nesciunt animi explicabo aperiam quis eum.	2025-02-03 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
33	646447-16	VF186207J9I228504	Volkswagen	Jetta	Vert	1	1	1	8	2017	2021-07-21	3075175.00	\N	169401	169401	\N	\N	5	\N	Asperiores illo nisi ex nobis et.	2025-07-28 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
52	891024-16	VF165654D4K799798	Peugeot	Partner	Blanc	1	1	1	8	2011	2024-12-01	4130295.00	\N	173448	173448	\N	\N	20	\N	Voluptatum consectetur rem tenetur eaque autem et.	2025-07-16 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	5	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
27	216089-16	VF121956F6S817870	Peugeot	Partner	Rouge	1	1	1	8	2010	2019-03-01	4090915.00	\N	118414	118414	\N	\N	9	\N	\N	2025-04-19 23:09:35	2025-11-13 14:55:56	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
66	722638-220-16	\N	TOYOTA	Yaris	Noir	1	1	1	8	2022	2022-03-09	\N	\N	0	\N	\N	\N	5	\N	\N	2025-11-08 01:45:43	2025-11-13 14:55:56	\N	1	\N	\N	\N	f	\N	\N	2025-11-08 00:45:43.523624	\N	t	\N	available	\N
18	576989-16	VF181818N6X268171	Isuzu	NQR	Noir	1	1	1	8	2017	2022-09-22	4551248.00	\N	9392	9392	\N	\N	12	\N	\N	2024-11-02 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
19	884005-16	VF130462B9K759456	Toyota	Hiace	Vert	1	1	1	8	2019	2023-10-17	2905865.00	\N	214226	214226	\N	\N	45	\N	\N	2024-12-30 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
20	513862-16	VF125375K3D385305	Peugeot	207	Rouge	1	1	1	8	2021	2023-07-26	2489881.00	\N	98171	98171	\N	\N	2	\N	Qui fugit excepturi quia ipsam aliquid quas modi qui.	2025-02-27 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
21	730617-16	VF149301U4P194090	Peugeot	208	Blanc	1	1	1	8	2011	2014-10-13	2589803.00	\N	214911	214911	\N	\N	20	\N	\N	2025-02-13 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
23	917404-16	VF141390T4Y052349	Peugeot	308	Blanc	1	1	1	8	2011	2019-08-02	807130.00	\N	137416	137416	\N	\N	2	\N	Est tempora natus at quaerat sint.	2025-03-15 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
24	590088-16	VF189855U4T515120	Toyota	Corolla	Vert	1	1	1	8	2024	2025-10-11	4923027.00	\N	140752	140752	\N	\N	2	\N	\N	2025-02-11 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
25	770735-16	VF135550V3X044779	Toyota	Hiace	Gris	1	1	1	8	2022	2024-09-09	4068284.00	\N	280485	280485	\N	\N	9	\N	\N	2024-12-15 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
48	524416-16	VF182189E8M523399	Renault	Trafic	Vert	1	1	1	8	2021	2023-01-10	2795611.00	\N	135624	135624	\N	\N	20	\N	Voluptatem sequi veritatis sunt repellendus quidem sint et praesentium.	2025-04-09 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
30	227013-16	VF125002V5E348893	Ford	Escort	Noir	1	1	1	8	2016	2019-08-31	2045761.00	\N	60114	60114	\N	\N	12	\N	\N	2025-07-24 23:10:33	2025-11-13 14:55:56	\N	1	\N	\N	5	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
58	655642-16	VF195961M8T882880	Renault	Sandero	Bleu	1	1	1	8	2012	2019-01-20	3973061.00	\N	225759	226700	\N	\N	7	\N	\N	2025-07-20 23:10:33	2025-11-13 14:55:56	\N	1	\N	\N	5	f	affecté	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
53	455989-16	VF121851I9F887433	Mercedes	Sprinter	Noir	1	1	1	8	2014	2025-06-21	3048425.00	\N	268221	268221	\N	\N	9	\N	\N	2025-06-08 23:10:33	2025-11-13 14:55:56	\N	1	\N	\N	\N	f	affecté	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
11	353018-16	VF156109B6U032018	Volkswagen	Golf	Gris	1	1	1	8	2021	2023-01-08	4890498.00	\N	246251	246251	\N	\N	45	\N	\N	2025-08-13 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
47	679937-16	VF164987K5V437083	Peugeot	301	Vert	1	1	1	8	2018	2020-07-07	3991326.00	\N	200600	200600	\N	\N	45	\N	Dolores rerum quas ut enim ullam eligendi sed.	2025-08-14 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	5	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
28	791763-16	VF170429X7E559490	Isuzu	NQR	Noir	1	1	1	8	2024	2025-10-11	1862353.00	\N	273624	273624	\N	\N	9	\N	\N	2024-10-24 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
36	210211-16	VF132844Y8R783202	Isuzu	FTR	Blanc	1	1	1	8	2010	2019-09-16	2830365.00	\N	166687	166687	\N	\N	7	\N	\N	2025-04-18 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
6	186125-16	VF164718Y9X738025	Toyota	Hilux	Vert	1	1	1	8	2012	2018-10-28	947993.00	\N	190248	190248	\N	\N	2	\N	\N	2024-10-28 23:09:35	2025-11-13 13:14:31	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
50	844874-16	VF117046B1F613910	Peugeot	308	Rouge	1	1	1	8	2021	2023-09-28	4017032.00	\N	154108	154108	\N	\N	5	\N	\N	2025-02-26 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
9	754842-16	VF163617F3F091002	Hyundai	Accent	Bleu	1	1	1	8	2018	2024-04-23	3908571.00	\N	209718	209718	\N	\N	5	\N	\N	2025-07-03 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
12	379418-16	VF189219Y6X746162	Iveco	Stralis	Rouge	1	1	1	8	2024	2025-10-11	3224905.00	\N	103559	103559	\N	\N	9	\N	\N	2025-02-16 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
15	462192-16	VF122991J6G248843	Peugeot	Boxer	Vert	1	1	1	8	2017	2023-03-26	1389142.00	\N	54398	54398	\N	\N	2	\N	Accusantium dolorum alias odio iusto.	2025-04-12 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
16	352064-16	VF116033N7Z163007	Isuzu	NQR	Rouge	1	1	1	8	2011	2024-09-01	4749012.00	\N	211013	211013	\N	\N	9	\N	\N	2024-10-31 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
55	321971-16	VF103487F3Z744941	Isuzu	D-Max	Blanc	1	1	1	8	2024	2025-10-11	3167830.00	\N	231737	231737	\N	\N	20	\N	\N	2024-12-29 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
17	631035-16	VF195215C3L783152	Hyundai	i10	Noir	1	1	1	8	2013	2017-11-12	4848201.00	\N	214309	214309	\N	\N	45	\N	\N	2024-12-16 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
2	534200-16	VF165979E2O782732	Toyota	Corolla	Noir	1	1	1	8	2018	2022-09-25	1227917.00	\N	5459	5459	\N	\N	7	\N	\N	2025-02-20 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	en_maintenance	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
5	403551-16	VF158905I3C713845	Toyota	Hilux	Bleu	1	1	1	8	2021	2023-09-11	3997249.00	\N	181532	181532	\N	\N	12	\N	\N	2025-03-07 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	en_maintenance	[]	2025-11-07 23:48:36	\N	t	\N	available	\N
4	378745-16	VF187286N0M711000	Ford	Focus	Bleu	1	1	1	8	2023	2025-09-28	3530465.00	\N	172582	172582	\N	\N	2	\N	\N	2024-12-06 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
7	211523-16	VF162451Q2R340381	Renault	Sandero	Blanc	1	1	1	8	2014	2018-12-12	3793691.00	\N	73569	73569	\N	\N	12	\N	Ut magni autem asperiores.	2025-01-21 23:09:35	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
49	872437-16	VF157757M2E691347	Mercedes	Vito	Rouge	1	1	1	8	2017	2025-04-20	3622763.00	\N	159775	150000	\N	\N	12	\N	\N	2025-08-09 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	t	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
34	194945-16	VF145357D5C322640	Volkswagen	Caddy	Gris	1	1	1	8	2011	2022-06-15	1602154.00	\N	169565	169565	\N	\N	7	\N	\N	2024-12-08 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
37	927085-16	VF126543T6P357733	Volkswagen	Caddy	Noir	1	1	1	8	2024	2025-10-11	3284484.00	\N	37070	37070	\N	\N	9	\N	\N	2024-11-12 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
31	126902-16	VF165306Z0H447467	Volkswagen	Crafter	Vert	1	1	1	8	2023	2024-11-05	1939239.00	\N	236032	236032	\N	\N	20	\N	\N	2025-04-16 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
42	326385-16	VF134702S4O624607	Toyota	Hiace	Blanc	1	1	1	8	2024	2025-10-11	2969287.00	\N	52613	52613	\N	\N	20	\N	\N	2025-05-07 23:10:33	2025-11-12 22:51:09	\N	1	\N	\N	5	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
67	10608-122-16	\N	TOYOTA	Yaris	blanc	3	1	1	8	2022	2022-04-05	\N	\N	0	23900	\N	\N	5	\N	\N	2025-11-08 02:29:04	2025-11-12 22:51:09	\N	1	\N	\N	16	f	\N	\N	2025-11-08 01:29:04.436082	\N	t	\N	available	\N
3	465544-16	VF144393X4F887124	Ford	Escort	Blanc	1	1	1	8	2022	2024-11-08	1956387.00	\N	228196	228196	\N	\N	20	\N	\N	2025-04-18 23:09:35	2025-11-13 14:55:56	\N	1	\N	\N	16	f	affecté	[]	2025-11-07 23:30:39	\N	t	\N	available	\N
57	976929-16	VF189455P7X801722	Peugeot	Partner	Bleu	1	1	1	8	2016	2023-02-13	4694844.00	\N	7907	7907	\N	\N	12	\N	\N	2025-06-03 23:10:33	2025-11-13 14:55:56	\N	1	\N	\N	\N	f	affecté	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
14	587449-16	VF162474A1U551965	Peugeot	206	Rouge	1	1	1	8	2022	2024-04-13	1529220.00	\N	185932	185932	\N	\N	45	\N	\N	2025-08-03 23:09:35	2025-11-13 14:55:56	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
38	139371-16	VF139527V0N786723	Hyundai	i10	Rouge	1	1	1	8	2019	2020-11-07	2359659.00	\N	133620	133620	\N	\N	20	\N	\N	2025-05-12 23:10:33	2025-11-13 14:55:56	\N	1	\N	\N	\N	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
10	589448-16	VF168274W9S785424	Renault	Clio	Blanc	1	1	1	8	2010	2013-09-05	1067400.00	\N	28211	28211	\N	\N	20	\N	\N	2025-05-28 23:09:35	2025-11-13 14:55:56	\N	1	\N	\N	5	f	affecté	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
26	105790-16	VF102667G2X843119	Peugeot	308	Vert	1	1	1	8	2020	2025-08-30	2100066.00	\N	294369	294369	\N	\N	45	\N	\N	2025-04-28 23:09:35	2025-11-13 23:16:01	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
22	118910-16	VF131499W2O126556	Hyundai	Tucson	Gris	1	1	1	9	2012	2024-07-19	3158370.00	\N	209039	209039	\N	\N	9	\N	\N	2025-06-07 23:09:35	2025-11-13 23:26:11	\N	1	\N	\N	16	f	parking	\N	2025-11-07 21:33:55.820127	\N	t	\N	available	\N
\.
...
SELECT pg_catalog.setval('public.assignments_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.depot_assignment_history_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.driver_statuses_id_seq', 10, true);
...
--
-- Name: expense_audit_logs_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: zenfleet_user
--

SELECT pg_catalog.setval('public.expense_audit_logs_id_seq1', 1, false);
...
SELECT pg_catalog.setval('public.failed_jobs_id_seq', 27, true);
...
--
-- Name: mileage_histories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: zenfleet_user
--

SELECT pg_catalog.setval('public.mileage_histories_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.permissions_id_seq', 263, true);
...
--
-- Name: status_histories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_history_id_seq; Type: SEQUENCE SET; Schema: public; Owner: zenfleet_user
--

SELECT pg_catalog.setval('public.status_history_id_seq', 66, true);


--
-- Name: status_transition_rules_id_seq; Type: SEQUENCE SET; Schema: public; Owner: zenfleet_user
--

SELECT pg_catalog.setval('public.status_transition_rules_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.vehicle_statuses_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.vehicle_types_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.vehicles_id_seq', 67, true);
...
--
-- Name: expense_audit_logs pk_expense_audit_logs; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs
    ADD CONSTRAINT pk_expense_audit_logs PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_05 expense_audit_logs_2025_05_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_05
    ADD CONSTRAINT expense_audit_logs_2025_05_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_06 expense_audit_logs_2025_06_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_06
    ADD CONSTRAINT expense_audit_logs_2025_06_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_07 expense_audit_logs_2025_07_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_07
    ADD CONSTRAINT expense_audit_logs_2025_07_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_08 expense_audit_logs_2025_08_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_08
    ADD CONSTRAINT expense_audit_logs_2025_08_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_09 expense_audit_logs_2025_09_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_09
    ADD CONSTRAINT expense_audit_logs_2025_09_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_10 expense_audit_logs_2025_10_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_10
    ADD CONSTRAINT expense_audit_logs_2025_10_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_11 expense_audit_logs_2025_11_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_11
    ADD CONSTRAINT expense_audit_logs_2025_11_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2025_12 expense_audit_logs_2025_12_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2025_12
    ADD CONSTRAINT expense_audit_logs_2025_12_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2026_01 expense_audit_logs_2026_01_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2026_01
    ADD CONSTRAINT expense_audit_logs_2026_01_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2026_02 expense_audit_logs_2026_02_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2026_02
    ADD CONSTRAINT expense_audit_logs_2026_02_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2026_03 expense_audit_logs_2026_03_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2026_03
    ADD CONSTRAINT expense_audit_logs_2026_03_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2026_04 expense_audit_logs_2026_04_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2026_04
    ADD CONSTRAINT expense_audit_logs_2026_04_pkey PRIMARY KEY (id, created_at);


--
-- Name: expense_audit_logs_2026_05 expense_audit_logs_2026_05_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.expense_audit_logs_2026_05
    ADD CONSTRAINT expense_audit_logs_2026_05_pkey PRIMARY KEY (id, created_at);
...
--
-- Name: mileage_histories mileage_histories_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_pkey PRIMARY KEY (id);
...
--
-- Name: status_histories status_histories_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_history status_history_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: status_transition_rules status_transition_rules_entity_type_from_status_to_status_key; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_transition_rules
    ADD CONSTRAINT status_transition_rules_entity_type_from_status_to_status_key UNIQUE (entity_type, from_status, to_status);


--
-- Name: status_transition_rules status_transition_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_transition_rules
    ADD CONSTRAINT status_transition_rules_pkey PRIMARY KEY (id);
...
CREATE INDEX idx_audit_risk ON ONLY public.comprehensive_audit_logs USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_04_risk_level_occurred_at_idx ON public.audit_logs_2025_04 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_05_risk_level_occurred_at_idx ON public.audit_logs_2025_05 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_06_risk_level_occurred_at_idx ON public.audit_logs_2025_06 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_07_risk_level_occurred_at_idx ON public.audit_logs_2025_07 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_08_risk_level_occurred_at_idx ON public.audit_logs_2025_08 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_09_risk_level_occurred_at_idx ON public.audit_logs_2025_09 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_10_risk_level_occurred_at_idx ON public.audit_logs_2025_10 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_11_risk_level_occurred_at_idx ON public.audit_logs_2025_11 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2025_12_risk_level_occurred_at_idx ON public.audit_logs_2025_12 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2026_01_risk_level_occurred_at_idx ON public.audit_logs_2026_01 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2026_02_risk_level_occurred_at_idx ON public.audit_logs_2026_02 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2026_03_risk_level_occurred_at_idx ON public.audit_logs_2026_03 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
CREATE INDEX audit_logs_2026_04_risk_level_occurred_at_idx ON public.audit_logs_2026_04 USING btree (risk_level, occurred_at DESC) WHERE ((risk_level)::text = ANY (ARRAY[('high'::character varying)::text, ('critical'::character varying)::text]));
...
--
-- Name: idx_expense_audit_action; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_action ON ONLY public.expense_audit_logs USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_05_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_action_action_category_idx ON public.expense_audit_logs_2025_05 USING btree (action, action_category);


--
-- Name: idx_expense_audit_ip; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_ip ON ONLY public.expense_audit_logs USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_05_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_ip_address_created_at_idx ON public.expense_audit_logs_2025_05 USING btree (ip_address, created_at DESC);


--
-- Name: idx_expense_audit_anomaly; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_anomaly ON ONLY public.expense_audit_logs USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_05_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_05 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: idx_expense_audit_org_created; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_org_created ON ONLY public.expense_audit_logs USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_05_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_organization_id_created_at_idx ON public.expense_audit_logs_2025_05 USING btree (organization_id, created_at DESC);


--
-- Name: idx_expense_audit_review; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_review ON ONLY public.expense_audit_logs USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_05_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_requires_review_reviewed_idx ON public.expense_audit_logs_2025_05 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: idx_expense_audit_session; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_session ON ONLY public.expense_audit_logs USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_05_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_session_id_idx ON public.expense_audit_logs_2025_05 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: idx_expense_audit_user; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_user ON ONLY public.expense_audit_logs USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_05_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_user_id_created_at_idx ON public.expense_audit_logs_2025_05 USING btree (user_id, created_at DESC);


--
-- Name: idx_expense_audit_expense; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expense_audit_expense ON ONLY public.expense_audit_logs USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_05_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_05_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_05 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_06_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_action_action_category_idx ON public.expense_audit_logs_2025_06 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_06_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_ip_address_created_at_idx ON public.expense_audit_logs_2025_06 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_06_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_06 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_06_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_organization_id_created_at_idx ON public.expense_audit_logs_2025_06 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_06_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_requires_review_reviewed_idx ON public.expense_audit_logs_2025_06 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_06_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_session_id_idx ON public.expense_audit_logs_2025_06 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_06_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_user_id_created_at_idx ON public.expense_audit_logs_2025_06 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_06_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_06_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_06 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_07_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_action_action_category_idx ON public.expense_audit_logs_2025_07 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_07_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_ip_address_created_at_idx ON public.expense_audit_logs_2025_07 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_07_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_07 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_07_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_organization_id_created_at_idx ON public.expense_audit_logs_2025_07 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_07_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_requires_review_reviewed_idx ON public.expense_audit_logs_2025_07 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_07_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_session_id_idx ON public.expense_audit_logs_2025_07 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_07_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_user_id_created_at_idx ON public.expense_audit_logs_2025_07 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_07_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_07_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_07 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_08_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_action_action_category_idx ON public.expense_audit_logs_2025_08 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_08_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_ip_address_created_at_idx ON public.expense_audit_logs_2025_08 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_08_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_08 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_08_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_organization_id_created_at_idx ON public.expense_audit_logs_2025_08 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_08_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_requires_review_reviewed_idx ON public.expense_audit_logs_2025_08 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_08_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_session_id_idx ON public.expense_audit_logs_2025_08 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_08_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_user_id_created_at_idx ON public.expense_audit_logs_2025_08 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_08_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_08_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_08 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_09_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_action_action_category_idx ON public.expense_audit_logs_2025_09 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_09_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_ip_address_created_at_idx ON public.expense_audit_logs_2025_09 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_09_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_09 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_09_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_organization_id_created_at_idx ON public.expense_audit_logs_2025_09 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_09_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_requires_review_reviewed_idx ON public.expense_audit_logs_2025_09 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_09_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_session_id_idx ON public.expense_audit_logs_2025_09 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_09_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_user_id_created_at_idx ON public.expense_audit_logs_2025_09 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_09_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_09_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_09 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_10_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_action_action_category_idx ON public.expense_audit_logs_2025_10 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_10_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_ip_address_created_at_idx ON public.expense_audit_logs_2025_10 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_10_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_10 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_10_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_organization_id_created_at_idx ON public.expense_audit_logs_2025_10 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_10_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_requires_review_reviewed_idx ON public.expense_audit_logs_2025_10 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_10_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_session_id_idx ON public.expense_audit_logs_2025_10 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_10_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_user_id_created_at_idx ON public.expense_audit_logs_2025_10 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_10_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_10_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_10 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_11_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_action_action_category_idx ON public.expense_audit_logs_2025_11 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_11_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_ip_address_created_at_idx ON public.expense_audit_logs_2025_11 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_11_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_11 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_11_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_organization_id_created_at_idx ON public.expense_audit_logs_2025_11 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_11_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_requires_review_reviewed_idx ON public.expense_audit_logs_2025_11 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_11_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_session_id_idx ON public.expense_audit_logs_2025_11 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_11_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_user_id_created_at_idx ON public.expense_audit_logs_2025_11 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_11_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_11_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_11 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_12_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_action_action_category_idx ON public.expense_audit_logs_2025_12 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2025_12_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_ip_address_created_at_idx ON public.expense_audit_logs_2025_12 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2025_12_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_is_anomaly_risk_level_idx ON public.expense_audit_logs_2025_12 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2025_12_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_organization_id_created_at_idx ON public.expense_audit_logs_2025_12 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_12_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_requires_review_reviewed_idx ON public.expense_audit_logs_2025_12 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2025_12_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_session_id_idx ON public.expense_audit_logs_2025_12 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2025_12_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_user_id_created_at_idx ON public.expense_audit_logs_2025_12 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2025_12_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2025_12_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2025_12 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_01_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_action_action_category_idx ON public.expense_audit_logs_2026_01 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2026_01_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_ip_address_created_at_idx ON public.expense_audit_logs_2026_01 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2026_01_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_is_anomaly_risk_level_idx ON public.expense_audit_logs_2026_01 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2026_01_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_organization_id_created_at_idx ON public.expense_audit_logs_2026_01 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_01_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_requires_review_reviewed_idx ON public.expense_audit_logs_2026_01 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2026_01_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_session_id_idx ON public.expense_audit_logs_2026_01 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2026_01_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_user_id_created_at_idx ON public.expense_audit_logs_2026_01 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_01_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_01_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2026_01 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_02_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_action_action_category_idx ON public.expense_audit_logs_2026_02 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2026_02_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_ip_address_created_at_idx ON public.expense_audit_logs_2026_02 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2026_02_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_is_anomaly_risk_level_idx ON public.expense_audit_logs_2026_02 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2026_02_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_organization_id_created_at_idx ON public.expense_audit_logs_2026_02 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_02_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_requires_review_reviewed_idx ON public.expense_audit_logs_2026_02 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2026_02_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_session_id_idx ON public.expense_audit_logs_2026_02 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2026_02_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_user_id_created_at_idx ON public.expense_audit_logs_2026_02 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_02_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_02_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2026_02 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_03_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_action_action_category_idx ON public.expense_audit_logs_2026_03 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2026_03_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_ip_address_created_at_idx ON public.expense_audit_logs_2026_03 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2026_03_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_is_anomaly_risk_level_idx ON public.expense_audit_logs_2026_03 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2026_03_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_organization_id_created_at_idx ON public.expense_audit_logs_2026_03 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_03_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_requires_review_reviewed_idx ON public.expense_audit_logs_2026_03 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2026_03_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_session_id_idx ON public.expense_audit_logs_2026_03 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2026_03_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_user_id_created_at_idx ON public.expense_audit_logs_2026_03 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_03_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_03_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2026_03 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_04_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_action_action_category_idx ON public.expense_audit_logs_2026_04 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2026_04_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_ip_address_created_at_idx ON public.expense_audit_logs_2026_04 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2026_04_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_is_anomaly_risk_level_idx ON public.expense_audit_logs_2026_04 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2026_04_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_organization_id_created_at_idx ON public.expense_audit_logs_2026_04 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_04_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_requires_review_reviewed_idx ON public.expense_audit_logs_2026_04 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2026_04_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_session_id_idx ON public.expense_audit_logs_2026_04 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2026_04_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_user_id_created_at_idx ON public.expense_audit_logs_2026_04 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_04_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_04_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2026_04 USING btree (vehicle_expense_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_05_action_action_category_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_action_action_category_idx ON public.expense_audit_logs_2026_05 USING btree (action, action_category);


--
-- Name: expense_audit_logs_2026_05_ip_address_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_ip_address_created_at_idx ON public.expense_audit_logs_2026_05 USING btree (ip_address, created_at DESC);


--
-- Name: expense_audit_logs_2026_05_is_anomaly_risk_level_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_is_anomaly_risk_level_idx ON public.expense_audit_logs_2026_05 USING btree (is_anomaly, risk_level) WHERE (is_anomaly = true);


--
-- Name: expense_audit_logs_2026_05_organization_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_organization_id_created_at_idx ON public.expense_audit_logs_2026_05 USING btree (organization_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_05_requires_review_reviewed_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_requires_review_reviewed_idx ON public.expense_audit_logs_2026_05 USING btree (requires_review, reviewed) WHERE (requires_review = true);


--
-- Name: expense_audit_logs_2026_05_session_id_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_session_id_idx ON public.expense_audit_logs_2026_05 USING btree (session_id) WHERE (session_id IS NOT NULL);


--
-- Name: expense_audit_logs_2026_05_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_user_id_created_at_idx ON public.expense_audit_logs_2026_05 USING btree (user_id, created_at DESC);


--
-- Name: expense_audit_logs_2026_05_vehicle_expense_id_created_at_idx; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX expense_audit_logs_2026_05_vehicle_expense_id_created_at_idx ON public.expense_audit_logs_2026_05 USING btree (vehicle_expense_id, created_at DESC);
...
CREATE INDEX idx_assignments_active ON public.assignments USING btree (organization_id, status) WHERE ((status)::text = ANY ((ARRAY['active'::character varying, 'pending'::character varying])::text[]));


--
-- Name: idx_assignments_brin; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_assignments_brin ON public.assignments USING brin (start_datetime, end_datetime) WITH (pages_per_range='64');
...
--
-- Name: idx_assignments_driver; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_assignments_driver ON public.assignments USING btree (driver_id, start_datetime DESC) WHERE ((deleted_at IS NULL) AND (driver_id IS NOT NULL));


--
-- Name: idx_assignments_expiry; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_assignments_expiry ON public.assignments USING btree (end_datetime, ended_at);
...
--
-- Name: idx_assignments_vehicle; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_assignments_vehicle ON public.assignments USING btree (vehicle_id, start_datetime DESC) WHERE (deleted_at IS NULL);


--
-- Name: idx_change_type; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_change_type ON public.status_history USING btree (change_type, changed_at);
...
--
-- Name: idx_dashboard_analytics; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_dashboard_analytics ON public.status_history USING btree (statusable_type, to_status, organization_id, changed_at);


--
-- Name: idx_documents_fts_optimized; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_documents_fts_optimized ON public.documents USING gin (search_vector) WITH (fastupdate=off, gin_pending_list_limit='4096');
...
--
-- Name: idx_drivers_assignment_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_assignment_status ON public.drivers USING btree (assignment_status);


--
-- Name: idx_drivers_availability; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_availability ON public.drivers USING btree (is_available);


--
-- Name: idx_drivers_availability_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_availability_status ON public.drivers USING btree (is_available, assignment_status);


--
-- Name: idx_drivers_license; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_license ON public.drivers USING btree (license_number, organization_id) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_drivers_phone; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_phone ON public.drivers USING btree (personal_phone) WHERE ((deleted_at IS NULL) AND (personal_phone IS NOT NULL));


--
-- Name: idx_drivers_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_status ON public.drivers USING btree (organization_id, status_id);


--
-- Name: idx_drivers_status_expires; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_drivers_status_expires ON public.drivers USING btree (status_expires_at) WHERE (status_expires_at IS NOT NULL);
...
--
-- Name: idx_expenses_brin; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expenses_brin ON public.vehicle_expenses USING brin (expense_date) WITH (pages_per_range='64');


--
-- Name: idx_expenses_monthly; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expenses_monthly ON public.vehicle_expenses USING btree (organization_id, expense_date DESC);


--
-- Name: idx_expenses_vehicle; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_expenses_vehicle ON public.vehicle_expenses USING btree (vehicle_id, expense_date DESC);


--
-- Name: idx_from_status_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_from_status_changed ON public.status_history USING btree (from_status, changed_at);
...
--
-- Name: idx_maintenance_mileage; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_maintenance_mileage ON public.maintenance_schedules USING btree (next_due_mileage, vehicle_id) WHERE (next_due_mileage IS NOT NULL);
...
--
-- Name: idx_maintenance_ops_vehicle; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_maintenance_ops_vehicle ON public.maintenance_operations USING btree (vehicle_id, created_at DESC) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_mileage_org; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_mileage_org ON public.mileage_histories USING btree (organization_id);


--
-- Name: idx_mileage_readings_brin; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_mileage_readings_brin ON public.vehicle_mileage_readings USING brin (recorded_at, created_at) WITH (pages_per_range='64');


--
-- Name: idx_mileage_readings_latest; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_mileage_readings_latest ON public.vehicle_mileage_readings USING btree (vehicle_id, recorded_at DESC, created_at DESC);
...
--
-- Name: idx_mileage_vehicle_date; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_mileage_vehicle_date ON public.mileage_histories USING btree (vehicle_id, recorded_at);


--
-- Name: idx_mv_status_analytics; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_mv_status_analytics ON public.mv_status_analytics USING btree (entity_type, date, organization_id);


--
-- Name: idx_org_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_org_changed ON public.status_history USING btree (organization_id, changed_at);
...
--
-- Name: idx_repairs_priority; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_repairs_priority ON public.repair_requests USING btree (priority, status, created_at DESC) WHERE (deleted_at IS NULL);


--
-- Name: idx_repairs_vehicle; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_repairs_vehicle ON public.repair_requests USING btree (vehicle_id, created_at DESC);
...
--
-- Name: idx_status_history_analytics; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_status_history_analytics ON public.status_histories USING btree (entity_type, new_status, changed_at);


--
-- Name: idx_status_history_entity; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_status_history_entity ON public.status_histories USING btree (entity_type, entity_id, changed_at DESC);


--
-- Name: idx_status_history_org; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_status_history_org ON public.status_histories USING btree (organization_id, changed_at DESC);


--
-- Name: idx_statusable_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_statusable_changed ON public.status_history USING btree (statusable_type, statusable_id, changed_at);
...
--
-- Name: idx_to_status_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_to_status_changed ON public.status_history USING btree (to_status, changed_at);


--
-- Name: idx_user_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_user_changed ON public.status_history USING btree (changed_by_user_id, changed_at);
...
--
-- Name: idx_vehicles_assignment_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_assignment_status ON public.vehicles USING btree (assignment_status);


--
-- Name: idx_vehicles_availability; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_availability ON public.vehicles USING btree (is_available);


--
-- Name: idx_vehicles_availability_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_availability_status ON public.vehicles USING btree (is_available, assignment_status);
...
--
-- Name: idx_vehicles_depot; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_depot ON public.vehicles USING btree (depot_id, organization_id);
...
--
-- Name: idx_vehicles_mileage; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_mileage ON public.vehicles USING btree (current_mileage DESC);
...
--
-- Name: idx_vehicles_org_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_org_status ON public.vehicles USING btree (organization_id, status_id) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_vehicles_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--
...
--
-- Name: idx_vehicles_status_changed; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_status_changed ON public.vehicles USING btree (status_changed_at DESC);
...
--
-- Name: idx_vehicles_type_status; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX idx_vehicles_type_status ON public.vehicles USING btree (organization_id, vehicle_type_id, status_id) WHERE (deleted_at IS NULL);
...
--
-- Name: status_history_statusable_type_statusable_id_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX status_history_statusable_type_statusable_id_index ON public.status_history USING btree (statusable_type, statusable_id);
...
--
-- Name: vehicle_depots_code_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_code_index ON public.vehicle_depots USING btree (code);


--
-- Name: vehicle_depots_is_active_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_is_active_index ON public.vehicle_depots USING btree (is_active);


--
-- Name: vehicle_depots_latitude_longitude_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_latitude_longitude_index ON public.vehicle_depots USING btree (latitude, longitude);


--
-- Name: vehicle_depots_organization_id_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_organization_id_index ON public.vehicle_depots USING btree (organization_id);


--
-- Name: vehicle_depots_organization_id_is_active_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_organization_id_is_active_index ON public.vehicle_depots USING btree (organization_id, is_active);


--
-- Name: vehicle_depots_status_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_status_index ON public.vehicle_depots USING btree (status);


--
-- Name: vehicle_depots_type_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_depots_type_index ON public.vehicle_depots USING btree (type);
...
--
-- Name: vehicle_statuses_organization_id_is_active_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_statuses_organization_id_is_active_index ON public.vehicle_statuses USING btree (organization_id, is_active);


--
-- Name: vehicle_statuses_slug_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_statuses_slug_index ON public.vehicle_statuses USING btree (slug);


--
-- Name: vehicle_statuses_sort_order_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_statuses_sort_order_index ON public.vehicle_statuses USING btree (sort_order);


--
-- Name: vehicle_types_organization_id_is_active_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_types_organization_id_is_active_index ON public.vehicle_types USING btree (organization_id, is_active);


--
-- Name: vehicle_types_slug_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_types_slug_index ON public.vehicle_types USING btree (slug);


--
-- Name: vehicle_types_sort_order_index; Type: INDEX; Schema: public; Owner: zenfleet_user
--

CREATE INDEX vehicle_types_sort_order_index ON public.vehicle_types USING btree (sort_order);
...
--
-- Name: expense_audit_logs_2025_05_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_05_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_05_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_05_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_05_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_05_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_05_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_05_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_05_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_05_pkey;


--
-- Name: expense_audit_logs_2025_05_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_05_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_05_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_05_session_id_idx;


--
-- Name: expense_audit_logs_2025_05_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_05_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_05_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_05_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_06_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_06_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_06_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_06_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_06_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_06_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_06_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_06_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_06_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_06_pkey;


--
-- Name: expense_audit_logs_2025_06_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_06_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_06_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_06_session_id_idx;


--
-- Name: expense_audit_logs_2025_06_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_06_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_06_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_06_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_07_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_07_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_07_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_07_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_07_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_07_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_07_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_07_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_07_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_07_pkey;


--
-- Name: expense_audit_logs_2025_07_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_07_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_07_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_07_session_id_idx;


--
-- Name: expense_audit_logs_2025_07_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_07_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_07_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_07_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_08_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_08_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_08_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_08_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_08_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_08_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_08_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_08_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_08_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_08_pkey;


--
-- Name: expense_audit_logs_2025_08_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_08_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_08_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_08_session_id_idx;


--
-- Name: expense_audit_logs_2025_08_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_08_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_08_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_08_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_09_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_09_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_09_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_09_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_09_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_09_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_09_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_09_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_09_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_09_pkey;


--
-- Name: expense_audit_logs_2025_09_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_09_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_09_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_09_session_id_idx;


--
-- Name: expense_audit_logs_2025_09_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_09_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_09_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_09_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_10_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_10_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_10_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_10_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_10_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_10_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_10_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_10_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_10_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_10_pkey;


--
-- Name: expense_audit_logs_2025_10_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_10_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_10_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_10_session_id_idx;


--
-- Name: expense_audit_logs_2025_10_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_10_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_10_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_10_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_11_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_11_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_11_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_11_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_11_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_11_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_11_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_11_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_11_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_11_pkey;


--
-- Name: expense_audit_logs_2025_11_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_11_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_11_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_11_session_id_idx;


--
-- Name: expense_audit_logs_2025_11_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_11_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_11_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_11_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_12_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2025_12_action_action_category_idx;


--
-- Name: expense_audit_logs_2025_12_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2025_12_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2025_12_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2025_12_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2025_12_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2025_12_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_12_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2025_12_pkey;


--
-- Name: expense_audit_logs_2025_12_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2025_12_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2025_12_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2025_12_session_id_idx;


--
-- Name: expense_audit_logs_2025_12_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2025_12_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2025_12_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2025_12_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_01_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2026_01_action_action_category_idx;


--
-- Name: expense_audit_logs_2026_01_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2026_01_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2026_01_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2026_01_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2026_01_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2026_01_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_01_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_01_pkey;


--
-- Name: expense_audit_logs_2026_01_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2026_01_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2026_01_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2026_01_session_id_idx;


--
-- Name: expense_audit_logs_2026_01_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2026_01_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_01_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2026_01_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_02_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2026_02_action_action_category_idx;


--
-- Name: expense_audit_logs_2026_02_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2026_02_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2026_02_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2026_02_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2026_02_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2026_02_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_02_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_02_pkey;


--
-- Name: expense_audit_logs_2026_02_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2026_02_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2026_02_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2026_02_session_id_idx;


--
-- Name: expense_audit_logs_2026_02_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2026_02_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_02_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2026_02_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_03_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2026_03_action_action_category_idx;


--
-- Name: expense_audit_logs_2026_03_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2026_03_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2026_03_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2026_03_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2026_03_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2026_03_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_03_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_03_pkey;


--
-- Name: expense_audit_logs_2026_03_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2026_03_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2026_03_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2026_03_session_id_idx;


--
-- Name: expense_audit_logs_2026_03_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2026_03_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_03_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2026_03_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_04_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2026_04_action_action_category_idx;


--
-- Name: expense_audit_logs_2026_04_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2026_04_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2026_04_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2026_04_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2026_04_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2026_04_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_04_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_04_pkey;


--
-- Name: expense_audit_logs_2026_04_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2026_04_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2026_04_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2026_04_session_id_idx;


--
-- Name: expense_audit_logs_2026_04_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2026_04_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_04_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2026_04_vehicle_expense_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_05_action_action_category_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_action ATTACH PARTITION public.expense_audit_logs_2026_05_action_action_category_idx;


--
-- Name: expense_audit_logs_2026_05_ip_address_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_ip ATTACH PARTITION public.expense_audit_logs_2026_05_ip_address_created_at_idx;


--
-- Name: expense_audit_logs_2026_05_is_anomaly_risk_level_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_anomaly ATTACH PARTITION public.expense_audit_logs_2026_05_is_anomaly_risk_level_idx;


--
-- Name: expense_audit_logs_2026_05_organization_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_org_created ATTACH PARTITION public.expense_audit_logs_2026_05_organization_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_05_pkey; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.pk_expense_audit_logs ATTACH PARTITION public.expense_audit_logs_2026_05_pkey;


--
-- Name: expense_audit_logs_2026_05_requires_review_reviewed_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_review ATTACH PARTITION public.expense_audit_logs_2026_05_requires_review_reviewed_idx;


--
-- Name: expense_audit_logs_2026_05_session_id_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_session ATTACH PARTITION public.expense_audit_logs_2026_05_session_id_idx;


--
-- Name: expense_audit_logs_2026_05_user_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_user ATTACH PARTITION public.expense_audit_logs_2026_05_user_id_created_at_idx;


--
-- Name: expense_audit_logs_2026_05_vehicle_expense_id_created_at_idx; Type: INDEX ATTACH; Schema: public; Owner: zenfleet_user
--

ALTER INDEX public.idx_expense_audit_expense ATTACH PARTITION public.expense_audit_logs_2026_05_vehicle_expense_id_created_at_idx;


--
-- Name: stat_assignments_vehicle_driver; Type: STATISTICS; Schema: public; Owner: zenfleet_user
--

CREATE STATISTICS public.stat_assignments_vehicle_driver (dependencies) ON vehicle_id, driver_id FROM public.assignments;


ALTER STATISTICS public.stat_assignments_vehicle_driver OWNER TO zenfleet_user;

--
-- Name: stat_expenses_org_date; Type: STATISTICS; Schema: public; Owner: zenfleet_user
--

CREATE STATISTICS public.stat_expenses_org_date (ndistinct, dependencies) ON organization_id, expense_date FROM public.vehicle_expenses;


ALTER STATISTICS public.stat_expenses_org_date OWNER TO zenfleet_user;

--
-- Name: stat_repairs_status_priority; Type: STATISTICS; Schema: public; Owner: zenfleet_user
--

CREATE STATISTICS public.stat_repairs_status_priority ON priority, status, urgency FROM public.repair_requests;


ALTER STATISTICS public.stat_repairs_status_priority OWNER TO zenfleet_user;

--
-- Name: stat_vehicles_org_depot; Type: STATISTICS; Schema: public; Owner: zenfleet_user
--

CREATE STATISTICS public.stat_vehicles_org_depot ON status_id, organization_id, depot_id FROM public.vehicles;


ALTER STATISTICS public.stat_vehicles_org_depot OWNER TO zenfleet_user;

--
-- Name: stat_vehicles_org_status; Type: STATISTICS; Schema: public; Owner: zenfleet_user
--

CREATE STATISTICS public.stat_vehicles_org_status (ndistinct, dependencies) ON status_id, organization_id FROM public.vehicles;


ALTER STATISTICS public.stat_vehicles_org_status OWNER TO zenfleet_user;
...
--
-- Name: drivers track_driver_status_change; Type: TRIGGER; Schema: public; Owner: zenfleet_user
--

CREATE TRIGGER track_driver_status_change AFTER UPDATE ON public.drivers FOR EACH ROW EXECUTE FUNCTION public.track_status_change();


--
-- Name: vehicles track_vehicle_status_change; Type: TRIGGER; Schema: public; Owner: zenfleet_user
--

CREATE TRIGGER track_vehicle_status_change AFTER UPDATE ON public.vehicles FOR EACH ROW EXECUTE FUNCTION public.track_status_change();
...
--
-- Name: drivers drivers_current_vehicle_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.drivers
    ADD CONSTRAINT drivers_current_vehicle_id_foreign FOREIGN KEY (current_vehicle_id) REFERENCES public.vehicles(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: drivers drivers_status_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.drivers
    ADD CONSTRAINT drivers_status_changed_by_fkey FOREIGN KEY (status_changed_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: expense_audit_logs fk_expense_audit_expense; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE public.expense_audit_logs
    ADD CONSTRAINT fk_expense_audit_expense FOREIGN KEY (vehicle_expense_id) REFERENCES public.vehicle_expenses(id) ON DELETE CASCADE;


--
-- Name: expense_audit_logs fk_expense_audit_org; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE public.expense_audit_logs
    ADD CONSTRAINT fk_expense_audit_org FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: expense_audit_logs fk_expense_audit_reviewer; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE public.expense_audit_logs
    ADD CONSTRAINT fk_expense_audit_reviewer FOREIGN KEY (reviewed_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: expense_audit_logs fk_expense_audit_user; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE public.expense_audit_logs
    ADD CONSTRAINT fk_expense_audit_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: mileage_histories mileage_histories_assignment_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_assignment_id_foreign FOREIGN KEY (assignment_id) REFERENCES public.assignments(id) ON DELETE SET NULL;


--
-- Name: mileage_histories mileage_histories_created_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_created_by_foreign FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: mileage_histories mileage_histories_driver_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_driver_id_foreign FOREIGN KEY (driver_id) REFERENCES public.drivers(id) ON DELETE SET NULL;


--
-- Name: mileage_histories mileage_histories_organization_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_organization_id_foreign FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: mileage_histories mileage_histories_vehicle_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.mileage_histories
    ADD CONSTRAINT mileage_histories_vehicle_id_foreign FOREIGN KEY (vehicle_id) REFERENCES public.vehicles(id) ON DELETE CASCADE;
...
--
-- Name: status_histories status_histories_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_histories
    ADD CONSTRAINT status_histories_changed_by_fkey FOREIGN KEY (changed_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: status_histories status_histories_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_histories
    ADD CONSTRAINT status_histories_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: status_history status_history_changed_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_history
    ADD CONSTRAINT status_history_changed_by_user_id_foreign FOREIGN KEY (changed_by_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: status_history status_history_organization_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.status_history
    ADD CONSTRAINT status_history_organization_id_foreign FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
...
--
-- Name: vehicle_statuses vehicle_statuses_organization_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.vehicle_statuses
    ADD CONSTRAINT vehicle_statuses_organization_id_foreign FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: vehicle_types vehicle_types_organization_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.vehicle_types
    ADD CONSTRAINT vehicle_types_organization_id_foreign FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
...
--
-- Name: vehicles vehicles_current_driver_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.vehicles
    ADD CONSTRAINT vehicles_current_driver_id_foreign FOREIGN KEY (current_driver_id) REFERENCES public.drivers(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: vehicles vehicles_status_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zenfleet_user
--

ALTER TABLE ONLY public.vehicles
    ADD CONSTRAINT vehicles_status_changed_by_fkey FOREIGN KEY (status_changed_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: mv_status_analytics; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: zenfleet_user
--

REFRESH MATERIALIZED VIEW public.mv_status_analytics;
...
\unrestrict 7WlRQpSvXfKTI45xndfky3iRJOjVEXdcfr52D26FBcDAgBNbSbae8162U851hTG
