...
<head>
 ...
 <meta name="csrf-token" content="nSLDrCeCIdgG1WGePNy8nZ9lo3X9aCt8u3jlo0q3">
 ...
 <link rel="preload" as="style" href="http://localhost/build/assets/app-CzwTMXPN.css" /><link rel="modulepreload" as="script" href="http://localhost/build/assets/app-aZSTW4yG.js" /><link rel="modulepreload" as="script" href="http://localhost/build/assets/vendor-common-B9ygI19o.js" /><link rel="modulepreload" as="script" href="http://localhost/build/assets/ui-public-2hikc2V1.js" /><link rel="stylesheet" href="http://localhost/build/assets/app-CzwTMXPN.css" data-navigate-track="reload" /><script type="module" src="http://localhost/build/assets/app-aZSTW4yG.js" data-navigate-track="reload"></script>  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
 <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/themes/light.css">
 <style>
 /* 🎨 FLATPICKR ENTERPRISE-GRADE LIGHT MODE - ZenFleet Ultra-Pro */
 .flatpickr-calendar {
...
></span>
 ...
 <input type="hidden" name="_token" value="nSLDrCeCIdgG1WGePNy8nZ9lo3X9aCt8u3jlo0q3" autocomplete="off"> <button type="submit"
    ...
    <div class="px-4 mx-auto">
        <ol class="flex items-start justify-center gap-0 w-full max-w-4xl mx-auto">
                    ...
                    <div class="flex items-center w-full relative z-10">
                        ...
                        <div class="flex items-center justify-center w-12 h-12 rounded-full flex-shrink-0 bg-white border-2 transition-all duration-300 relative"
                            ...
                            <span class="iconify w-6 h-6 transition-colors duration-300"
                                ...
                                x-bind:data-icon="'lucide:' + &quot;identification&quot;"
                                data-inline="false">
                            </span>
                        </div>
                ...
                <form method="POST" action="http://localhost/admin/drivers" enctype="multipart/form-data" @submit="onSubmit" class="p-6">
                    <input type="hidden" name="_token" value="nSLDrCeCIdgG1WGePNy8nZ9lo3X9aCt8u3jlo0q3" autocomplete="off">                    <input type="hidden" name="current_step" x-model="currentStep">
...
></span>
 ...
 value=""
     data-max-date="2025-12-08"  data-date-format="d/m/Y"
 autocomplete="off"
...
></span>
 ...
 placeholder="Choisir une date"
 value=""
    data-min-date="2025-12-08"   data-date-format="d/m/Y"
 autocomplete="off"
 ...
 Date de fin du contrat (optionnel)
        ...
        <label for="slimselect-status_id-693730894c924" class="block mb-2 text-sm font-medium text-gray-900">
        Statut du Chauffeur
    ...
    <select
        name="status_id"
        id="slimselect-status_id-693730894c924"
        class="slimselect-field w-full"
        data-slimselect="true"
        data-placeholder="Sélectionnez un statut..."
         required                         @change="validateField('status_id', $event.target.value)">
...
></span>
 <span>Ce champ est obligatoire et doit être correctement rempli</span>
        ...
        <label for="slimselect-license_categories[]-693730894ce53" class="block mb-2 text-sm font-medium text-gray-900">
    ...
    <select
        ...
        id="slimselect-license_categories[]-693730894ce53"
        class="slimselect-field w-full"
        data-slimselect="true"
        data-placeholder="Sélectionner les catégories"
         required                  multiple         @change="validateField('license_categories', $event.target.value)">
...
></span>
 ...
 placeholder="Choisir une date"
 value=""
  required     data-max-date="2025-12-08"  data-date-format="d/m/Y"
 autocomplete="off"
...
></span>
 ...
 placeholder="Choisir une date"
 value=""
  required    data-min-date="2025-12-08"   data-date-format="d/m/Y"
 autocomplete="off"
...
></span>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="">
        <label for="slimselect-user_id-693730894e890" class="block mb-2 text-sm font-medium text-gray-900">
        Compte utilisateur
            </label>
    
    <select
        name="user_id"
        id="slimselect-user_id-693730894e890"
        class="slimselect-field w-full"
        data-slimselect="true"
...
<script>
 ...
 function toastManager() {
    ...
    <script data-navigate-once="true">window.livewireScriptConfig = {"csrf":"nSLDrCeCIdgG1WGePNy8nZ9lo3X9aCt8u3jlo0q3","uri":"\/livewire\/update","progressBar":"","nonce":""};</script>
</body>
</html>